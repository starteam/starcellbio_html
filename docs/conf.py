...
htmlhelp_basename = 'starcellbio_htmldoc'
...
man_pages = [
    ('index', 'starcellbio_html', u'starcellbio_html Documentation',
...
texinfo_documents = [
  ('index', 'starcellbio_html', u'starcellbio_html Documentation',
   u'Massachusetts Institute of Technology', 'starcellbio_html', 'One line description of project.',
   'Miscellaneous'),
]
