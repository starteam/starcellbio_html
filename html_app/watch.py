...
html_suffix += "</head><body><div id='main'></div><script>$(function(){ var jquery = $.noConflict();if(! window.$ ) { window.$ = jquery; } starcellbio('#main',{});}); window.clearCookie = function() { document.cookie='sessionid=\"invalid\"'};</script></body>"
# add raven
