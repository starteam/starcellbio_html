...
scb_ex.dialog = function(opt_data, opt_sb) {
  ...
  output.append('<div class=\'scb_ex_inner_dialog\' role=\'dialog\' aria-label=\'Add Samples\'><h1 class=\'scb_ex_inner_dialog_title\' role=\'presentation\' aria-label=\'Add Samples\'><span class=\'scb_ex_inner_dialog_title_close\' role=\'button\' aria-label=\'Close Add Samples\'>&#215;</span>Add multiple rows </h1><div class=\'scb_ex_inner_dialog_body\'><table class="scb_s_experiment_setup_table" role=\'grid\' aria-label=\'Cell Lines\'><thead class="scb_s_experiment_setup_table_head"><td role=\'columnheader\' aria-label=\'selected\' class=\'scb_s_experiment_setup_table_heading\' style=\'width:80px\'>Selected</td><td role=\'columnheader\' aria-label=\'cell line\' class=\'scb_s_experiment_setup_table_heading\'>Cell Line</td></thead><tbody class="scb_s_experiment_setup_table_body">');
