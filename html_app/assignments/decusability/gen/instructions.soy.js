...
scb_assignment_specific_decusability.question_1 = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<div><br/><div class=\'scb_objective_number scb_objective_design\' role=\'heading\'><div>1</div></div><div class=\'scb_objective_text\'>To further characterize the mutant strains, your advisor recommends that you first analyze the mutant strains\' DNA content by flow cytometry. She hopes that the results of the DNA content analysis will provide the necessary data to further characterize these cell cycle mutants and determine the arrest point at which the mutant strains are arresting.<p>Perform a flow cytometry experiment(s) to further characterize the DNA content of the Mutant 1 and Mutant 2 strains. What is the DNA content profile of the Mutant 1 and Mutant 2 strains? What is the effect, if any, of the mutations in the Mutant 1 and Mutant 2 strains on the DNA content? Please discuss your answers to these questions with your usability evaluator.</p></div><p></p><p></p></div>');
  return opt_sb ? '' : output.toString();
};
...
scb_assignment_specific_decusability.question_2 = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<div><br/><div class=\'scb_objective_number scb_objective_design\' role=\'heading\'><div>2</div></div><div class=\'scb_objective_text\'>You present your flow cytometry experiment results and analyses to your faculty advisor. She suggests that it will be beneficial to conduct other experiments to further characterize the mutant strains. She urges you to perform western blotting to determine the protein levels of key cell cycle proteins in the mutant strains when grown at the restrictive temperature and allows you to purchase many antibodies to complete a thorough western blotting analysis. Note: the <u><b class=\'scb_s_ref_info_link\' style=\'color:blue; cursor:pointer;\'>Reference Material</b></u>&nbsp; section contains more information about the available antibodies.<p>Perform a western blotting experiment(s) to further characterize protein expression of key cell cycle proteins in the Mutant 1 and Mutant 2 strains. What is the effect(s) of the mutations in the Mutant 1 and Mutant 2 strains on the protein levels of the cdk2, cyclin B, cyclin E, and pgk1 proteins? Please discuss your answers to these questions with your usability evaluator.</p></div><p></p><p></p></div>');
  return opt_sb ? '' : output.toString();
};


scb_assignment_specific_decusability.intro = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<div><h2 style=\'margin-top:0px;\' role=\'heading\'>Introduction</h2><div class=\'scb_s_mit706s13_assignment_overview\' ><p>The lab in which you are completing a UROP, studies the cell cycle in a newly identified budding yeast strain, called <i>S. cellbiae</i>. In prior experiments on cell cycle regulation in <i>S. cellbiae</i>, the lab discovered that <i>S. cellbiae</i> has homologs of key cell cycle genes that function in the same manner to regulate the cell cycle as in higher eukaryotes.</p><p>A graduate student in the lab performed a genetic screen to isolate genes important for cell cycle progression. Since loss-of-function mutations in cell cycle genes often lead to lethality, the screen was designed to identify temperature-sensitive mutants, which means that they exhibit the wild-type phenotype at the permissive temperature (30 &deg;C) and the mutant phenotype at the restrictive temperature (37 &deg;C). The graduate student looked for strains that (a) fail to produce colonies at the restrictive temperature and (b) have mutant phenotypes when examined under the microscope following incubation at the restrictive temperature for different lengths of time. He identified two strains that accumulate in different phases of the cell cycle only when at the restrictive temperature. He named the two newly identified mutant strains, Mutant 1 and Mutant 2. Your UROP project is to further characterize these mutant strains using western blotting and flow cytometry.</p></div></div>');
  return opt_sb ? '' : output.toString();
};


scb_assignment_specific_decusability.ref = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<div><h2 style=\'margin-top:0px;\' role=\'heading\'>Reference Material</h2><div class=\'scb_s_mit706s13_assignment_overview\' ><p>The <b>Reference Material</b>&nbsp; contains more information about the strains and treatments that are available to you within StarCellBio.</p>Within StarCellBio you will have access to the following:<br/><br/><ol><li>Wild-type, Mutant 1, and Mutant 2 haploid strains that are growing asynchronously.</li><li>Two temperatures, 30 &deg;C (permissive) and 37 &deg;C (restrictive), at which you can perform your experiments.</li></ol><p>In addition, the table below contains information regarding the antibodies that are available to you and the molecular weight of the proteins to which they bind. The following antibodies are available to you in StarCellBio: <br/><br/><table class=\'scb_s_objective_table\' role=\'grid\'><thead><td role=\'columnheader\'>Protein Name</td><td role=\'columnheader\'>Molecular Weight (kDa)</td></thead><tbody><tr role=\'row\'><td>Cdk2</td><td>33</td></tr><tr role=\'row\'><td>Cyclin B</td><td>58</td></tr><tr role=\'row\'><td>Cyclin E</td><td>48</td></tr><tr role=\'row\'><td>Pgk1 (loading control)</td><td>45</td></tr></tbody></table></p></div></div>');
  return opt_sb ? '' : output.toString();
};
