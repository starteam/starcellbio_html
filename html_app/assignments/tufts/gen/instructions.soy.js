...
scb_assignment_specific_tufts.assignment_detail = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<div class=\'scb_s_tufts_assignment_detail\'><h2>Questions</h2><div class=\'scb_objective_main\'></div>Please use the program to design and interpret two experiments:<br><p></p><div class=\'scb_objective_number\'><div>1</div></div><div class=\'scb_objective_text\'><p>Use the program to design an experiment to determine if the EGFR kinase inhibitor (erlotinib) blocks activation of the Ras pathway downstream of the EGFR. Print a copy of the final exposed blot(s), which should include a list of the samples you chose. Note: Not all samples should be used in this experiment. Use the samples that will directly answer the question asked. Make sure to include a loading control.</p></div><p></p><div class=\'scb_objective_number\'><div>1</div></div><div class=\'scb_objective_text\'><p>Use the program to design an experiment to determine if the Mek kinase inhibitor (U0126) blocks activation of the Ras pathway downstream of the EGFR. Print a copy of the final exposed blot(s), which should include a list of the samples you chose. Note: Not all samples should be used in this experiment. Use the samples that will directly answer the question asked. Make sure to include a loading control.</p></div><p></p><br></div>');
  return opt_sb ? '' : output.toString();
};
