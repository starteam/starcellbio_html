var add_multiple_dialog = add_multiple_dialog || {};
add_multiple_dialog.static = add_multiple_dialog.static || {};

add_multiple_dialog.static.scb_mit706s16_inner_dialog_add = function (element, dialog, state) {
...
add_multiple_dialog.register = function (dialog, state) {
    ...
    scb.utils.off_on(dialog.parent(), 'click', '.scb_mit706s16_inner_dialog_add', function (e) {
        add_multiple_dialog.static.scb_mit706s16_inner_dialog_add(this, dialog, state);
        $(this).focus();
    });
...
add_multiple_dialog.setup = function (state) {
    ...
    dialog.html(add_multiple_dialog.dialog({
    ...
    add_multiple_dialog.register($(dialog), state);
