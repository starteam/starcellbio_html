...
if (typeof add_multiple_dialog == 'undefined') { var add_multiple_dialog = {}; }


add_multiple_dialog.dialog = function(opt_data, opt_sb) {
  ...
  output.append('<div class=\'scb_mit706s16_button_float\'><button class=\'scb_mit706s16_inner_dialog_cancel scb_s_gray_button\'>CANCEL</button><button class=\'scb_mit706s16_inner_dialog_add scb_s_gray_button\'>ADD SAMPLES</button></div></div></div>');
