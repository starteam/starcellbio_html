...
scb_instructor_experiment_setup_page2.main = function(opt_data, opt_sb) {
  ...
  scb_instructor_experiment_setup_page2.display_assignment({global_template: opt_data.global_template, assignments: opt_data.assignments, view: 'select_course'}, output);
  output.append('</div>');
