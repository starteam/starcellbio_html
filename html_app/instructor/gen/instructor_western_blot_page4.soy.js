...
scb_instructor_western_blot_page4.main = function(opt_data, opt_sb) {
  ...
  scb_instructor_western_blot_page4.display_assignment({global_template: opt_data.global_template, assignments: opt_data.assignments, view: 'select_course'}, output);
  output.append('</div>');
