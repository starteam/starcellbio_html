...
scb.ui.static.InstructorMicroscopyPage1View = scb.ui.static.InstructorMicroscopyPage1View || {};
...
scb.ui.static.InstructorMicroscopyPage1View.scb_f_select_technique_save_assignment_button = function(element, workarea){
...
scb.ui.static.InstructorMicroscopyPage1View.register = function(workarea) {
    scb.utils.off_on(workarea, 'change', '.scb_f_select_technique_save_assignment_button', function (e) {
    	scb.ui.static.InstructorMicroscopyPage1View.scb_f_select_technique_save_assignment_button(this, e);
    });
...
scb.ui.static.InstructorMicroscopyPage1View.rows = function(dialog){
	var rows =[];
...
scb.ui.InstructorMicroscopyPage1View = function scb_ui_InstructorMicroscopyPage1View(gstate) {
    ...
    self.show = function (state) {
        ...
        var rows = scb.ui.static.InstructorMicroscopyPage1View.rows(assignments.selected.template.ui.add_multiple_dialog);
