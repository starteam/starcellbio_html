...
scb.ui.static.InstructorHomepageView = scb.ui.static.InstructorHomepageView || {} ;

scb.ui.static.InstructorHomepageView.select_list_item = function(element,workarea,aria)
{
...
scb.ui.static.InstructorHomepageView.register = function(workarea) {
    scb.utils.off_on(workarea, 'click', '.scb_s_homepage_experimental_design_bullet_item', function (e) {
        scb.ui.static.InstructorHomepageView.select_list_item(this,workarea,true);
    });
...
scb.ui.InstructorHomepageView = function scb_ui_InstructorHomepageView(gstate) {
	var self = this;
	self.show = function(state) {
        ...
        scb.ui.static.InstructorHomepageView.select_list_item($('.scb_s_homepage_experimental_design_bullet_item').first(),gstate.workarea,false);
