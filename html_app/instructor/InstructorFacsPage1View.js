...
scb.ui.static.InstructorFacsPage1View.scb_f_select_technique_save_assignment_button = function(element, workarea){
...
scb.ui.static.InstructorFacsPage1View.register = function(workarea) {
    scb.utils.off_on(workarea, 'change', '.scb_f_select_technique_save_assignment_button', function (e) {
    	scb.ui.static.InstructorFacsPage1View.scb_f_select_technique_save_assignment_button(this, e);
    });
...
scb.ui.static.InstructorFacsPage1View.rows = function(dialog){
	var rows =[];
...
scb.ui.InstructorFacsPage1View = function scb_ui_InstructorFacsPage1View(gstate) {
    ...
    self.show = function (state) {
        ...
        var rows = scb.ui.static.InstructorFacsPage1View.rows(assignments.selected.template.ui.add_multiple_dialog);
