...
scb_experiment_design.display_details = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<div class=\'scb_s_experiment_design_container\'  aria-live="assertive" role=\'alert\' ><div class=\'scb_s_design_description\'>');
...
scb_experiment_design.display_techniques = function(opt_data, opt_sb) {
  ...
  for (var techIndex69 = 0; techIndex69 < techListLen69; techIndex69++) {
    ...
    output.append((techData69 == 'wb') ? '<span class=\'scb_s_experiment_design_technique_wb ' + ((opt_data.experiment.design_wb_cb) ? 'scb_s_experiment_design_selected' : 'scb_s_experiment_design_unselected') + '\'><div class=\'scb_s_experiment_design_technique \' assignment_id=\'' + soy.$$escapeHtml(opt_data.assignment.id) + '\' experiment_id=\'' + soy.$$escapeHtml(opt_data.experiment.id) + '\' data-key=\'design_wb_cb\' role="button" ' + ((opt_data.experiment.design_wb_cb) ? 'aria-selected="true"' : '') + '><span class=\'scb_s_homepage_technique_title_image\'>Western Blot</span>Western blotting detects overall changes in the amount or chemical modifications of a particular protein. <a href="static/ref_lib/full_library.html#WesternBlotting" class=\'scb_s_design_technique_learn_more \' target=\'_blank\'>Learn more &gt;&gt;</a></div></span><div class=\'scb_s_experiment_design_divider_1\'></div>' : '', (techData69 == 'fc') ? '<span class=\'scb_s_experiment_design_technique_flow ' + ((opt_data.experiment.design_fc_cb) ? 'scb_s_experiment_design_selected' : 'scb_s_experiment_design_unselected') + '\'><div class=\'scb_s_experiment_design_technique \' assignment_id=\'' + soy.$$escapeHtml(opt_data.assignment.id) + '\' experiment_id=\'' + soy.$$escapeHtml(opt_data.experiment.id) + '\' data-key=\'design_fc_cb\' role="button" ' + ((opt_data.experiment.design_fc_cb) ? 'aria-selected="true"' : '') + '><span class=\'scb_s_homepage_technique_title_image\'>Flow Cytometry</span>Flow cytometry is used to count and analyze the size, shape and properties of individual cells within a heterogeneous population of cells.     <a href="static/ref_lib/full_library.html#FlowCytometry" class=\'scb_s_design_technique_learn_more \' target=\'_blank\'>Learn more &gt;&gt;</a></div></span><div class=\'scb_s_experiment_design_divider_2\'></div>' : '', (techData69 == 'fc') ? '<span class=\'scb_s_experiment_design_technique_micro ' + ((opt_data.experiment.design_mi_cb) ? 'scb_s_experiment_design_selected' : 'scb_s_experiment_design_unselected') + '\'><div role=\'button\' class = \'scb_s_experiment_design_technique \' assignment_id=\'' + soy.$$escapeHtml(opt_data.assignment.id) + '\' experiment_id=\'' + soy.$$escapeHtml(opt_data.experiment.id) + '\' data-key=\'design_mi_cb\' role="button" ' + ((opt_data.experiment.design_mi_cb) ? 'aria-selected="true"' : '') + '><span class=\'scb_s_homepage_technique_title_image\'>Microscopy</span>Microscopy is used to study the shape, morphology and properties of cells, tissues or organisms that otherwise cannot be observed by eye.     <a href="static/ref_lib/full_library.html#Microscopy" class=\'scb_s_design_technique_learn_more \' target=\'_blank\'>Learn more &gt;&gt;</a></div></span>' : '');
  }
  return opt_sb ? '' : output.toString();
};
