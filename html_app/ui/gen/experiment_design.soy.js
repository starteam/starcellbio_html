...
scb_experiment_design.display_details = function(opt_data, opt_sb) {
  ...
  output.append('</span><span class=\'scb_s_experiment_design_techniques_tq_note\'>Please note that by selecting a technique(s), you will not alter the techniques that are available to you for this experiment.</span></div><br/><a class="scb_f_open_experiment_setup scb_s_navigation_button" href="#view=experiment_setup&assignment_id=', soy.$$escapeHtml(opt_data.assignment.id), '&experiment_id=', soy.$$escapeHtml(opt_data.experiment.id), '">EXPERIMENT SETUP &nbsp; &#9654;</a><br/><a class="scb_f_open_assignment scb_s_navigation_button" href="#view=assignment&assignment_id=', soy.$$escapeHtml(opt_data.assignment.id), '">&#9664; &nbsp; COMPLETE ASSIGNMENT</a></div>');
  return opt_sb ? '' : output.toString();
};
