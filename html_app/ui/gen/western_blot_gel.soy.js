...
scb_western_blot_gel.undeveloped_gel = function(opt_data, opt_sb) {
  ...
  for (var pabIndex331 = 0; pabIndex331 < pabListLen331; pabIndex331++) {
    ...
    output.append('<option class=\'scb_f_wb_anti_body_select_primary_option\' model_id=\'', soy.$$escapeHtml(pabData331), '\'', (opt_data.western_blot_gel.primary_anti_body == pabData331) ? 'selected=\'selected\'' : '', '>', soy.$$escapeHtml(opt_data.t.primary_anti_body[pabData331].name), '</option>');
  }
  ...
  var pabList356 = soy.$$getMapKeys(opt_data.t.secondary_anti_body);
  var pabListLen356 = pabList356.length;
  for (var pabIndex356 = 0; pabIndex356 < pabListLen356; pabIndex356++) {
    var pabData356 = pabList356[pabIndex356];
    output.append('<option class=\'scb_f_wb_anti_body_select_secondary_option\' model_id=\'', soy.$$escapeHtml(pabData356), '\'', (opt_data.western_blot_gel.secondary_anti_body == pabData356) ? 'selected=\'selected\'' : '', '>', soy.$$escapeHtml(opt_data.t.secondary_anti_body[pabData356].name), '</option>');
  }
