...
scb_western_blot_gel.display_tabs = function(opt_data, opt_sb) {
  ...
  for (var rIndex84 = 0; rIndex84 < rListLen84; rIndex84++) {
    ...
    output.append((rData84.is_valid) ? '<li class="scb_s_western_blot_choose_samples_list" id=' + soy.$$escapeHtml(rData84.lane.id) + '>' + soy.$$escapeHtml(rData84.display_text) + ' -' + soy.$$escapeHtml(rData84.lane.kinds[rData84.lane.kind].name) + '</li>' : '');
  }
  output.append('</ol>');
  var start__soy96 = opt_data.valid_rows + 1;
  output.append('<ol class=\'scb_s_western_blot_choose_samples_marker\' start=', soy.$$escapeHtml(start__soy96), '>', (opt_data.western_blot.marker_loaded == true) ? '<li class="scb_s_western_blot_marker">Marker</li>' : '', '</ol></div>', (opt_data.western_blot.marker_loaded == false) ? '<div class=\'scb_s_western_blot_marker scb_s_western_blot_marker_not\'>No marker loaded.</div>' : '', '</div><div class=\'scb_s_western_blot_samples_gel_area\'><div class=\'scb_s_western_blot_gel_tabs\'>');
  if (opt_data.western_blot.gel_list.length < 5) {
    ...
    for (var gelIndex110 = 0; gelIndex110 < gelListLen110; gelIndex110++) {
      ...
      output.append((opt_data.western_blot_gel.id == gelData110.id) ? '<span class=\'scb_s_western_blot_gel_active scb_s_western_blot_gel_tab\'><div class=\'scb_s_western_blot_gel_tab_selected\' western_blot_id=\'' + soy.$$escapeHtml(opt_data.western_blot.id) + '\' assignment_id=\'' + soy.$$escapeHtml(opt_data.assignment.id) + '\' experiment_id=\'' + soy.$$escapeHtml(opt_data.experiment.id) + '\' western_blot_gel_id=\'' + soy.$$escapeHtml(gelData110.id) + '\' ' + ((gelData110.is_developed) ? ' ="true"' : '') + '>' + soy.$$escapeHtml(gelData110.name) + '</div>' + ((gelData110.is_developed) ? '<button class=\'scb_f_western_blot_gel_remove\' western_blot_id=\'' + soy.$$escapeHtml(opt_data.western_blot.id) + '\' assignment_id=\'' + soy.$$escapeHtml(opt_data.assignment.id) + '\' experiment_id=\'' + soy.$$escapeHtml(opt_data.experiment.id) + '\' western_blot_gel_id=\'' + soy.$$escapeHtml(gelData110.id) + '\'>| &#215;<!--                 \t\t<img src=\'images/setup/scb_remove.png\'> --></button>' : '') + '</span>' : '<div class=\'scb_s_western_blot_gel_tab\' western_blot_id=\'' + soy.$$escapeHtml(opt_data.western_blot.id) + '\' assignment_id=\'' + soy.$$escapeHtml(opt_data.assignment.id) + '\' experiment_id=\'' + soy.$$escapeHtml(opt_data.experiment.id) + '\' western_blot_gel_id=\'' + soy.$$escapeHtml(gelData110.id) + '\'><a href=\'#view=western_blot_gel&experiment_id=' + soy.$$escapeHtml(opt_data.experiment.id) + '&assignment_id=' + soy.$$escapeHtml(opt_data.assignment.id) + '&western_blot_id=' + soy.$$escapeHtml(opt_data.western_blot.id) + '&western_blot_gel_id=' + soy.$$escapeHtml(gelData110.id) + '\'>' + soy.$$escapeHtml(gelData110.name) + '</a></div>');
    }
  } else {
    ...
    var gelList169 = opt_data.western_blot.gel_list.list;
    var gelListLen169 = gelList169.length;
    for (var gelIndex169 = 0; gelIndex169 < gelListLen169; gelIndex169++) {
      var gelData169 = gelList169[gelIndex169];
      output.append((gelIndex169 >= opt_data.western_blot.gel_list.start_tabs_index && gelIndex169 < opt_data.western_blot.gel_list.start_tabs_index + 4) ? (opt_data.western_blot_gel.id == gelData169.id) ? '<span class=\'scb_s_western_blot_gel_active scb_s_western_blot_gel_tab\'><div class=\'scb_s_western_blot_gel_tab_selected\' western_blot_id=\'' + soy.$$escapeHtml(opt_data.western_blot.id) + '\' assignment_id=\'' + soy.$$escapeHtml(opt_data.assignment.id) + '\' experiment_id=\'' + soy.$$escapeHtml(opt_data.experiment.id) + '\' western_blot_gel_id=\'' + soy.$$escapeHtml(gelData169.id) + '\' ' + ((gelData169.is_developed) ? ' ="true"' : '') + '>' + soy.$$escapeHtml(gelData169.name) + '</div>' + ((gelData169.is_developed) ? '<button class=\'scb_f_western_blot_gel_remove\' western_blot_id=\'' + soy.$$escapeHtml(opt_data.western_blot.id) + '\' assignment_id=\'' + soy.$$escapeHtml(opt_data.assignment.id) + '\' experiment_id=\'' + soy.$$escapeHtml(opt_data.experiment.id) + '\' western_blot_gel_id=\'' + soy.$$escapeHtml(gelData169.id) + '\'>| &#215;<!--                 \t\t<img src=\'images/setup/scb_remove.png\'> --></button>' : '') + '</span>' : '<div class=\'scb_s_western_blot_gel_tab\' western_blot_id=\'' + soy.$$escapeHtml(opt_data.western_blot.id) + '\' assignment_id=\'' + soy.$$escapeHtml(opt_data.assignment.id) + '\' experiment_id=\'' + soy.$$escapeHtml(opt_data.experiment.id) + '\' western_blot_gel_id=\'' + soy.$$escapeHtml(gelData169.id) + '\'><a href=\'#view=western_blot_gel&experiment_id=' + soy.$$escapeHtml(opt_data.experiment.id) + '&assignment_id=' + soy.$$escapeHtml(opt_data.assignment.id) + '&western_blot_id=' + soy.$$escapeHtml(opt_data.western_blot.id) + '&western_blot_gel_id=' + soy.$$escapeHtml(gelData169.id) + '\'>' + soy.$$escapeHtml(gelData169.name) + '</a></div>' : '');
    }
...
scb_western_blot_gel.undeveloped_gel = function(opt_data, opt_sb) {
  ...
  var pabList290 = soy.$$getMapKeys(opt_data.t.primary_anti_body);
  var pabListLen290 = pabList290.length;
  for (var pabIndex290 = 0; pabIndex290 < pabListLen290; pabIndex290++) {
    var pabData290 = pabList290[pabIndex290];
    output.append('<option class=\'scb_f_wb_anti_body_select_primary_option\' model_id=\'', soy.$$escapeHtml(pabData290), '\'', (opt_data.western_blot_gel.primary_anti_body == pabData290) ? 'selected=\'selected\'' : '', '>', soy.$$escapeHtml(opt_data.t.primary_anti_body[pabData290].name), '</option>');
  }
  ...
  var pabList315 = soy.$$getMapKeys(opt_data.t.secondary_anti_body);
  var pabListLen315 = pabList315.length;
  for (var pabIndex315 = 0; pabIndex315 < pabListLen315; pabIndex315++) {
    var pabData315 = pabList315[pabIndex315];
    output.append('<option class=\'scb_f_wb_anti_body_select_secondary_option\' model_id=\'', soy.$$escapeHtml(pabData315), '\'', (opt_data.western_blot_gel.secondary_anti_body == pabData315) ? 'selected=\'selected\'' : '', '>', soy.$$escapeHtml(opt_data.t.secondary_anti_body[pabData315].name), '</option>');
  }
