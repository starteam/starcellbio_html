...
scb_western_blot_gel.display_gel = function(opt_data, opt_sb) {
  ...
  if (opt_data.western_blot_gel.is_developed) {
    output.append('<button class=\'scb_f_info_icon scb_s_western_blot_exposure_info\' note=\'scb_f_wb_exposure_followup\'> </button><div class=\'scb_f_wb_exposure_followup scb_f_controls_note\'>The exposure slider represents the length of time a piece of film is exposed on a blot to detect a protein of interest. To increase the exposure time, move the slider to the right. To decrease the exposure time, move the slider to the left. &nbsp;<a href="static/ref_lib/full_library.html#Develop" target=\'_blank\' class=\'scb_s_select_technique_learn_more \'>Learn more &gt;&gt;</a></div>');
    scb_western_blot_gel.developed_gel(opt_data, output);
  } else {
    output.append('<button class=\'scb_f_info_icon scb_s_western_blot_primary_info\' note=\'scb_f_wb_primary_followup\'> </button><div class=\'scb_f_wb_primary_followup scb_f_controls_note\'>A primary antibody is a Y-shaped protein that is designed to bind specifically to the protein of interest. A primary antibody called "rabbit protein-X" was raised in a rabbit to specifically detect protein X. &nbsp;<a href="static/ref_lib/full_library.html#Blot" target=\'_blank\' class=\'scb_s_select_technique_learn_more \'>Learn more &gt;&gt;</a></div><button class=\'scb_f_info_icon scb_s_western_blot_secondary_info\' note=\'scb_f_wb_secondary_followup\'> </button><div class=\'scb_f_wb_secondary_followup scb_f_controls_note\'>A secondary antibody is a Y-shaped protein that is designed to bind specifically to the primary antibody. A secondary antibody called "goat anti-rabbit" was raised in a goat to detect a rabbit\'s primary antibody. When selecting a secondary antibody, ensure that the secondary antibody recognizes the species in which a primary antibody was raised. &nbsp;<a href="static/ref_lib/full_library.html#Blot" target=\'_blank\' class=\'scb_s_select_technique_learn_more \'>Learn more &gt;&gt;</a></div>');
