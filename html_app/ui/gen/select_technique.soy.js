...
scb_select_technique.display_details = function(opt_data, opt_sb) {
  ...
  for (var wIndex32 = 0; wIndex32 < wListLen32; wIndex32++) {
    ...
    output.append('<a role=\'link\' class=\'scb_f_open_western_blot scb_s_select_technique_open_western_blot\' assignment_id=\'', soy.$$escapeHtml(opt_data.assignment.id), '\' experiment_id=\'', soy.$$escapeHtml(opt_data.experiment.id), '\' western_blot_id=\'', soy.$$escapeHtml(wData32.id), '\' href=\'#view=western_blot&experiment_id=', soy.$$escapeHtml(opt_data.experiment.id), '&assignment_id=', soy.$$escapeHtml(opt_data.assignment.id), '&western_blot_id=', soy.$$escapeHtml(wData32.id), '\'>', soy.$$escapeHtml(wData32.name), '</a><br>');
  }
  output.append((opt_data.experiment.western_blot_list.length == 0) ? '<ul class=\'scb_s_select_technique_list\'><li class=\'scb_s_select_technique_none\'>You have not performed any western blot analyses.</li><li class=\'scb_s_select_technique_none\'>Select <b>New Western Blot</b> below to start a western blot analysis.</li></ul>' : '', '</div><a role=\'button\' class=\'scb_s_navigation_button scb_f_new_western_blot \' href=\'#view=western_blot&experiment_id=', soy.$$escapeHtml(opt_data.experiment.id), '&assignment_id=', soy.$$escapeHtml(opt_data.assignment.id), '\'>NEW WESTERN BLOT &nbsp; &#9654;</a><p class=\'scb_s_select_technique_para\'><span class=\'scb_s_select_technique_reminder\'>Reminder:</span><br>Western blotting detects overall changes in the amount or chemical modifications of a particular protein. &nbsp;<a role=\'link\' href="static/ref_lib/full_library.html#WesternBlotting" target=\'_blank\' class=\'scb_s_select_technique_learn_more \'>Learn more &gt;&gt;</a></p></div><div class=\'scb_s_select_technique_flow scb_f_select_technique\'><h1 class=\'scb_s_select_technique_header\'>Flow Cytometry Analyses:</h1><div class=\'scb_s_select_technique_western_blot_available\' aria-label=\'List of Flow Cytometry Experiments\'>');
  ...
  for (var wIndex82 = 0; wIndex82 < wListLen82; wIndex82++) {
    ...
    output.append('<a role=\'link\' class=\'scb_f_open_microscopy scb_s_select_technique_open_microscopy\' assignment_id=\'', soy.$$escapeHtml(opt_data.assignment.id), '\' experiment_id=\'', soy.$$escapeHtml(opt_data.experiment.id), '\' microscopy_id=\'', soy.$$escapeHtml(wData82.id), '\' href=\'#view=microscopy&experiment_id=', soy.$$escapeHtml(opt_data.experiment.id), '&assignment_id=', soy.$$escapeHtml(opt_data.assignment.id), '&microscopy_id=', soy.$$escapeHtml(wData82.id), '\'>', soy.$$escapeHtml(wData82.name), '</a><br>');
  }
  output.append((opt_data.experiment.microscopy_list.length == 0) ? '<ul class=\'scb_s_select_technique_list\'><li class=\'scb_s_select_technique_none\'>You have not performed any microscopy analyses.</li><li class=\'scb_s_select_technique_none\'>Select <b>New Microscopy</b> below to start a microscopy analysis.</li></ul>' : '', '</div><a role=\'button\' class=\'scb_s_navigation_button scb_f_new_microscopy \' href=\'#view=microscopy&experiment_id=', soy.$$escapeHtml(opt_data.experiment.id), '&assignment_id=', soy.$$escapeHtml(opt_data.assignment.id), '\'>NEW MICROSCOPY &nbsp; &#9654;</a><p class=\'scb_s_select_technique_para\'><span class=\'scb_s_select_technique_reminder\'>Reminder:</span><br>Microscopy is used to study the shape, morphology and properties of cells, tissues or organisms that otherwise cannot be observed by eye. &nbsp;<a role=\'link\' href="static/ref_lib/full_library.html#Microscopy" target=\'_blank\' class=\'scb_s_select_technique_learn_more \'>Learn more &gt;&gt;</a></p></div></div><a class="scb_s_navigation_button scb_f_open_experiment_setup_readonly" href="#view=experiment_run&assignment_id=', soy.$$escapeHtml(opt_data.assignment.id), '&experiment_id=', soy.$$escapeHtml(opt_data.experiment.id), '" role=\'button\' >&#9664; &nbsp; REVIEW SET-UP</a><br/></div>');
  return opt_sb ? '' : output.toString();
};
