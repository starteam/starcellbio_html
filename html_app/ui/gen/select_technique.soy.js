...
scb_select_technique.display_details = function(opt_data, opt_sb) {
  ...
  var wList66 = opt_data.experiment.microscopy_list.list;
  var wListLen66 = wList66.length;
  for (var wIndex66 = 0; wIndex66 < wListLen66; wIndex66++) {
    var wData66 = wList66[wIndex66];
    output.append('<a class=\'scb_f_open_microscopy scb_s_select_technique_open_microscopy\' microscopy_id=\'', soy.$$escapeHtml(wData66.id), '\' href=\'#view=microscopy&experiment_id=', soy.$$escapeHtml(opt_data.experiment.id), '&assignment_id=', soy.$$escapeHtml(opt_data.assignment.id), '&microscopy_id=', soy.$$escapeHtml(wData66.id), '\'>', soy.$$escapeHtml(wData66.name), '</a><br>');
  }
