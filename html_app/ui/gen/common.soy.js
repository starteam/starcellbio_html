...
scb_common.assignment_step = function(opt_data, opt_sb) {
  ...
  if (opt_data.step > 0) {
    ...
    if (opt_data.step > 5 || opt_data.last_step > 5) {
      var tview__soy127 = new soy.StringBuilder((opt_data.assignments) ? soy.$$escapeHtml(opt_data.assignments.selected.experiments.selected.last_view) : (opt_data.assignment) ? soy.$$escapeHtml(opt_data.assignment.experiments.selected.last_view) : (opt_data.experiment) ? soy.$$escapeHtml(opt_data.experiment.last_view) : soy.$$escapeHtml(opt_data.technique_view));
      tview__soy127 = tview__soy127.toString();
      var tname__soy137 = new soy.StringBuilder((tview__soy127 == 'western_blot') ? 'WESTERN BLOT' : (tview__soy127 == 'facs') ? 'FLOW CYTOMETRY' : (tview__soy127 == 'microscopy') ? 'MICROSCOPY' : soy.$$escapeHtml(opt_data.technique_name));
      tname__soy137 = tname__soy137.toString();
      var tparam__soy147 = new soy.StringBuilder((tview__soy127 == 'western_blot') ? 'western_blot_id' : (tview__soy127 == 'facs') ? 'facs_id' : (tview__soy127 == 'microscopy') ? 'microscopy_id' : soy.$$escapeHtml(opt_data.technique_param));
      tparam__soy147 = tparam__soy147.toString();
      var tid__soy157 = new soy.StringBuilder((opt_data.assignments) ? (tview__soy127 == 'western_blot') ? soy.$$escapeHtml(opt_data.assignments.selected.experiments.selected.western_blot_list.selected_id) : (tview__soy127 == 'facs') ? soy.$$escapeHtml(opt_data.assignments.selected.experiments.selected.facs_list.selected_id) : (tview__soy127 == 'microscopy') ? soy.$$escapeHtml(opt_data.assignments.selected.experiments.selected.microscopy_list.selected_id) : '' : (opt_data.assignment) ? (tview__soy127 == 'western_blot') ? soy.$$escapeHtml(opt_data.assignment.experiments.selected.western_blot_list.selected_id) : (tview__soy127 == 'facs') ? soy.$$escapeHtml(opt_data.assignment.experiments.selected.facs_list.selected_id) : (tview__soy127 == 'microscopy') ? soy.$$escapeHtml(opt_data.assignment.experiments.selected.microscopy_list.selected_id) : '' : (opt_data.experiment) ? (tview__soy127 == 'western_blot') ? soy.$$escapeHtml(opt_data.experiment.western_blot_list.selected_id) : (tview__soy127 == 'facs') ? soy.$$escapeHtml(opt_data.experiment.facs_list.selected_id) : (tview__soy127 == 'microscopy') ? soy.$$escapeHtml(opt_data.experiment.microscopy_list.selected_id) : '' : soy.$$escapeHtml(opt_data.technique_id));
      tid__soy157 = tid__soy157.toString();
      output.append('<a class=\'scb_s_assignment_step_link ', (opt_data.step == 6) ? 'scb_s_assignment_step_link_active' : '', '\' href=\'#view=', soy.$$escapeHtml(tview__soy127), '&assignment_id=', soy.$$escapeHtml(aid__soy11), '&experiment_id=', soy.$$escapeHtml(eid__soy3), '&', soy.$$escapeHtml(tparam__soy147), '=', soy.$$escapeHtml(tid__soy157), '\'>', soy.$$escapeHtml(tname__soy137), '</a><img src=\'images/header/scb_navigation_arrow.png\' alt=\'\'>');
    }
    output.append('</div>');
  }
