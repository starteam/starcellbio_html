...
scb_common.assignment_step = function(opt_data, opt_sb) {
  ...
  if (opt_data.step > 0) {
    output.append('<div class=\'scb_s_assignment_step\' xmlns="http://www.w3.org/1999/html" xmlns="http://www.w3.org/1999/html">', (opt_data.step > 0) ? '<a class=\'scb_s_assignment_step_link\' href=\'#view=assignments\'>ASSIGNMENTS</a><img src=\'images/header/scb_navigation_arrow.png\' alt=\'\'>' : '', (opt_data.step > 1) ? '<a class=\'scb_s_assignment_step_link ' + ((opt_data.step == 2) ? 'scb_s_assignment_step_link_active' : '') + '\' href=\'#view=assignment&assignment_id=' + soy.$$escapeHtml(opt_data.assignment.id) + '\'>' + soy.$$escapeHtml(opt_data.assignment_name) + '</a><img src=\'images/header/scb_navigation_arrow.png\' alt=\'\'>' : '');
    if (opt_data.step > 2) {
      output.append('<a class=\'scb_s_assignment_step_link ', (opt_data.step == 3) ? 'scb_s_assignment_step_link_active' : '', '\' href=\'#view=experiment_design&assignment_id=', soy.$$escapeHtml(opt_data.assignment.id), '&experiment_id=', soy.$$escapeHtml(opt_data.experiment.id), '\'>DESIGN</a><img src=\'images/header/scb_navigation_arrow.png\' alt=\'\'><div class=\'scb_s_assignment_step_experiment_block\'><img class=\'scb_s_assignment_step_experiment_box\' src=\'images/header/exp_name_box.png\' alt=\'\'><div class=\'scb_s_assignment_step_experiment\'><!-- &#8988; --> <!-- ', soy.$$escapeHtml(opt_data.experiment_name), '  --><label class="custom-select"><select onchange="location = this.options[this.selectedIndex].value;">');
      var eList33 = opt_data.assignment.experiments.list;
      var eListLen33 = eList33.length;
      for (var eIndex33 = 0; eIndex33 < eListLen33; eIndex33++) {
        var eData33 = eList33[eIndex33];
        output.append('<option value=\'#view=experiment_last&assignment_id=', soy.$$escapeHtml(opt_data.assignment.id), '&experiment_id=', soy.$$escapeHtml(eData33.id), '\' model_id=\'', soy.$$escapeHtml(opt_data.assignment.id), '\' sub_model_id=\'', soy.$$escapeHtml(opt_data.experiment.id), '\' ', (opt_data.experiment.id == eData33.id) ? 'selected="selected"' : '', '> ', soy.$$escapeHtml(eData33.name), '&nbsp;&nbsp;', (opt_data.experiment.id == eData33.id) ? '&#x25BC;' : '', '</option>');
      }
      output.append('<option class=\'scb_s_assignment_step_experiment_new_option\' value=\'#view=experiment_design&assignment_id=', soy.$$escapeHtml(opt_data.assignment.id), '\' model_id=\'', soy.$$escapeHtml(opt_data.assignment.id), '\'>+New Experiment</option></select></label></div><img class=\'scb_s_assignment_step_experiment_line\' src=\'images/header/exp_name_line.png\' alt=\'\'></div>');
    }
    output.append((opt_data.step > 3) ? '<a class=\'scb_s_assignment_step_link ' + ((opt_data.step == 4) ? 'scb_s_assignment_step_link_active' : '') + '\' href=\'#view=experiment_setup&assignment_id=' + soy.$$escapeHtml(opt_data.assignment.id) + '&experiment_id=' + soy.$$escapeHtml(opt_data.experiment.id) + '\'>SETUP</a><img src=\'images/header/scb_navigation_arrow.png\' alt=\'\'>' : '', (opt_data.step > 4) ? '<a class=\'scb_s_assignment_step_link ' + ((opt_data.step == 5) ? 'scb_s_assignment_step_link_active' : '') + '\' href=\'#view=select_technique&assignment_id=' + soy.$$escapeHtml(opt_data.assignment.id) + '&experiment_id=' + soy.$$escapeHtml(opt_data.experiment.id) + '\'>TECHNIQUES</a><img src=\'images/header/scb_navigation_arrow.png\' alt=\'\'>' : '', (opt_data.step > 5) ? '<a class=\'scb_s_assignment_step_link ' + ((opt_data.step == 6) ? 'scb_s_assignment_step_link_active' : '') + '\' href=\'#view=' + soy.$$escapeHtml(opt_data.technique_view) + '&assignment_id=' + soy.$$escapeHtml(opt_data.assignment.id) + '&experiment_id=' + soy.$$escapeHtml(opt_data.experiment.id) + '&' + soy.$$escapeHtml(opt_data.technique_param) + '=' + soy.$$escapeHtml(opt_data.technique_id) + '\'>' + soy.$$escapeHtml(opt_data.technique_name) + '</a><img src=\'images/header/scb_navigation_arrow.png\' alt=\'\'>' : '', '</div>');
  }
