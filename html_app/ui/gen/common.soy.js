...
scb_common.experiment_step = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<div class=\'scb_s_experiment_step\'><div class = \'scb_s_experiment_step_progress_label\'> ', soy.$$escapeHtml(opt_data.assignment.name), '</div><div class=\'scb_s_assignment_step_experiment\'><label class="custom-select"><select onchange="location = this.value;">');
  var eList211 = opt_data.assignment.experiments.list;
  var eListLen211 = eList211.length;
  for (var eIndex211 = 0; eIndex211 < eListLen211; eIndex211++) {
    var eData211 = eList211[eIndex211];
    output.append('<option value=\'#view=experiment_last&assignment_id=', soy.$$escapeHtml(opt_data.assignment.id), '&experiment_id=', soy.$$escapeHtml(eData211.id), '\' model_id=\'', soy.$$escapeHtml(opt_data.assignment.id), '\' sub_model_id=\'', soy.$$escapeHtml(opt_data.experiment.id), '\'', (opt_data.experiment.id == eData211.id) ? 'selected="selected"' : '', '>', soy.$$escapeHtml(eData211.name), '&nbsp;&nbsp;<!-- \t\t\t\t\t\t\t\t', (opt_data.experiment.id == eData211.id) ? '&#x25BC;' : '', ' --></option>');
  }
  output.append('</select></label></div><br/><br/><div class=\'scb_s_experiment_step_vertical_line_1\'></div><div class=\'scb_s_experiment_step_vertical_line_2\'></div><div class=\'scb_s_experiment_step_vertical_line_3\'></div><div class=\'scb_s_experiment_step_vertical_line_4\'></div><div class=\'scb_s_experiment_step_vertical_line_5\'></div><div class="scb_s_experiment_step_div "><div class=\'scb_s_experiment_step_black_bar \'><div class=\'scb_s_experiment_step_vertical_line_1_top\'></div><div class=\'scb_s_experiment_step_vertical_line_2_top\'></div><div class=\'scb_s_experiment_step_vertical_line_3_top\'></div><div class=\'scb_s_experiment_step_vertical_line_4_top\'></div><div class=\'scb_s_experiment_step_vertical_line_5_top\'></div><div class=\'scb_s_experiment_step_green_bar \' style=\'width:', (opt_data.step == 1) ? '45px;' : '', (opt_data.step == 2) ? '135px;' : '', (opt_data.step == 3) ? '225px;' : '', (opt_data.step == 4) ? '315px;' : '', (opt_data.step == 5) ? '440px;' : '', '\'></div></div><div class=\'scb_s_experiment_step_labels\'><div class=\'scb_s_experiment_step_text\'>DESIGN</div><div class=\'scb_s_experiment_step_text scb_s_experiment_step_text_after\'>SETUP</div><div class=\'scb_s_experiment_step_text scb_s_experiment_step_text_after\'>RUN</div><div class=\'scb_s_experiment_step_text scb_s_experiment_step_text_after\'>SELECT TECHNIQUE</div><div class=\'scb_s_experiment_step_text scb_s_experiment_step_text_after\'>PERFORM TECHNIQUE</div></div></div></div>');
  return opt_sb ? '' : output.toString();
};
