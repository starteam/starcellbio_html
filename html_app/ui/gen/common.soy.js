...
scb_common.assignment_step = function(opt_data, opt_sb) {
  ...
  output.append((opt_data.step > 0) ? '<div class=\'scb_s_assignment_step\' xmlns="http://www.w3.org/1999/html" xmlns="http://www.w3.org/1999/html">' + ((opt_data.step > 0) ? '<a class=\'scb_s_assignment_step_link\' href=\'#view=assignments\'>ASSIGNMENTS</a>' : '') + ((opt_data.step > 1) ? '<a class=\'scb_s_assignment_step_link\' href=\'#view=assignment&assignment_id=' + soy.$$escapeHtml(opt_data.assignment.id) + '\'>' + soy.$$escapeHtml(opt_data.assignment_name) + '</a>' : '') + ((opt_data.step > 2) ? '<a class=\'scb_s_assignment_step_link\' href=\'#view=experiment_design&assignment_id=' + soy.$$escapeHtml(opt_data.assignment.id) + '&experiment_id=' + soy.$$escapeHtml(opt_data.experiment.id) + '\'>DESIGN</a><div class=\'scb_s_assignment_step_experiment\' >&#8988; ' + soy.$$escapeHtml(opt_data.experiment_name) + '</div>' : '') + ((opt_data.step > 3) ? '<a class=\'scb_s_assignment_step_link\' href=\'#view=experiment_setup&assignment_id=' + soy.$$escapeHtml(opt_data.assignment.id) + '&experiment_id=' + soy.$$escapeHtml(opt_data.experiment.id) + '\'>SETUP</a>' : '') + ((opt_data.step > 4) ? '<a class=\'scb_s_assignment_step_link\' href=\'#view=select_technique&assignment_id=' + soy.$$escapeHtml(opt_data.assignment.id) + '&experiment_id=' + soy.$$escapeHtml(opt_data.experiment.id) + '\'>TECHNIQUES</a>' : '') + ((opt_data.step > 5) ? '<a class=\'scb_s_assignment_step_link\' href=\'#view=' + soy.$$escapeHtml(opt_data.technique_view) + '&assignment_id=' + soy.$$escapeHtml(opt_data.assignment.id) + '&experiment_id=' + soy.$$escapeHtml(opt_data.experiment.id) + '&' + soy.$$escapeHtml(opt_data.technique_param) + '=' + soy.$$escapeHtml(opt_data.technique_id) + '\'>' + soy.$$escapeHtml(opt_data.technique_name) + '</a>' : '') + '</div>' : '');
