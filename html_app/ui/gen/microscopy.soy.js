...
scb_microscopy.prepare_slide = function(opt_data, opt_sb) {
  ...
  var rList422 = opt_data.rows;
  var rListLen422 = rList422.length;
  for (var rIndex422 = 0; rIndex422 < rListLen422; rIndex422++) {
    var rData422 = rList422[rIndex422];
    output.append((rData422.is_valid) ? '<li microscopy_lane_id=\'' + soy.$$escapeHtml(rData422.lane.id) + '\' assignment_id=\'' + soy.$$escapeHtml(opt_data.assignment.id) + '\' experiment_id=\'' + soy.$$escapeHtml(opt_data.experiment.id) + '\' microscopy_id=\'' + soy.$$escapeHtml(opt_data.microscopy.id) + '\' lane_kind = \'' + soy.$$escapeHtml(rData422.lane.kind) + '\' slide_conditions = \'' + soy.$$escapeHtml(rData422.lane.slide_conditions) + '\'' + ((opt_data.microscopy.lane_selected == rData422.lane.id) ? 'class=\'scb_s_microscopy_sample_selected\'' : '') + '>&nbsp;&nbsp;' + soy.$$escapeHtml(rData422.display_text) + ' - ' + soy.$$escapeHtml(rData422.lane.kinds[rData422.lane.kind].name) + ' - ' + soy.$$escapeHtml(rData422.lane.kinds[rData422.lane.kind].conditions[rData422.lane.slide_conditions].name) + '</li>' : '');
  }
  ...
  if (opt_data.microscopy.samples_finished) {
    var rList463 = opt_data.rows;
    var rListLen463 = rList463.length;
    for (var rIndex463 = 0; rIndex463 < rListLen463; rIndex463++) {
      var rData463 = rList463[rIndex463];
      if (rData463.is_valid && opt_data.microscopy.lane_selected == rData463.lane.id) {
        scb_microscopy.display_lens({assignment: opt_data.assignment, experiment: opt_data.experiment, microscopy: opt_data.microscopy, lane: rData463.lane, microscopy_line_id: opt_data.microscopy.lane_selected}, output);
      }
    }
  } else {
...
scb_microscopy.display_lens_new = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  var lane__soy566 = new soy.StringBuilder('$microscopy.lanes_list.get($microscopy_line_id)');
  lane__soy566 = lane__soy566.toString();
  output.append('<div class=\'scb_s_microscopy_slide_content\' assignment_id=\'', soy.$$escapeHtml(opt_data.assignment.id), '\' experiment_id=\'', soy.$$escapeHtml(opt_data.experiment.id), '\' microscopy_id=\'', soy.$$escapeHtml(opt_data.microscopy.id), '\'', (opt_data.microscopy_line_id) ? 'microscopy_lane_id=\'' + soy.$$escapeHtml(opt_data.microscopy_line_id) + '\'' : '', '><div id=\'scb_s_microscopy_lens_controls\'><span class=\'scb_s_controls_note\'>Note: Use keyboard arrow keys to navigate lens across the slide.</span><p class = \'scb_space_control\'/>Light<p class = \'scb_space_control\'/><img src=\'images/microscopy/up.jpg\' class =\'scb_s_micro_arrows\' id=\'brightup\'/> <br/><img src =\'images/microscopy/down.jpg\' class =\'scb_s_micro_arrows\'id=\'brightdown\'/><p class = \'scb_space_control\'/>Focus: Rough<p class = \'scb_space_control\'/><img src =\'images/microscopy/up.jpg\' class =\'scb_s_micro_arrows\' id=\'blurup\'/><br/><img src = \'images/microscopy/down.jpg\' class =\'scb_s_micro_arrows\' id=\'blurdown\'/><p class = \'scb_space_control\'/>Focus: Fine<p class = \'scb_space_control\'/><img src = \'images/microscopy/fineup.jpg\' class =\'scb_s_micro_arrows\' id=\'fblurup\'/> <br/><img src = \'images/microscopy/finedown.jpg\' class =\'scb_s_micro_arrows\'id=\'fblurdown\'/><p class = \'scb_space_control\'/><button class=\'scb_s_microscopy_red\' microscopy_id=\'', soy.$$escapeHtml(opt_data.microscopy.id), '\' assignment_id=\'', soy.$$escapeHtml(opt_data.assignment.id), '\' experiment_id=\'', soy.$$escapeHtml(opt_data.experiment.id), '\' ', (lane__soy566.red_enabled) ? '' : 'disabled=\'disabled\'', '>Red</button><button class=\'scb_f_microscopy_blue\' microscopy_id=\'', soy.$$escapeHtml(opt_data.microscopy.id), '\' assignment_id=\'', soy.$$escapeHtml(opt_data.assignment.id), '\' experiment_id=\'', soy.$$escapeHtml(opt_data.experiment.id), '\' ', (lane__soy566.blue_enabled) ? '' : 'disabled=\'disabled\'', '>Blue</button><button class=\'scb_f_microscopy_green\' microscopy_id=\'', soy.$$escapeHtml(opt_data.microscopy.id), '\' assignment_id=\'', soy.$$escapeHtml(opt_data.assignment.id), '\' experiment_id=\'', soy.$$escapeHtml(opt_data.experiment.id), '\' ', (lane__soy566.green_enabled) ? '' : 'disabled=\'disabled\'', '>Green</button><button class=\'scb_f_microscopy_all\' microscopy_id=\'', soy.$$escapeHtml(opt_data.microscopy.id), '\' assignment_id=\'', soy.$$escapeHtml(opt_data.assignment.id), '\' experiment_id=\'', soy.$$escapeHtml(opt_data.experiment.id), '\' ', (lane__soy566.merge_enabled) ? '' : 'disabled=\'disabled\'', '>Merge</button><input type="checkbox" class="scb_f_microscopy_laser" microscopy_id=\'', soy.$$escapeHtml(opt_data.microscopy.id), '\' assignment_id=\'', soy.$$escapeHtml(opt_data.assignment.id), '\' experiment_id=\'', soy.$$escapeHtml(opt_data.experiment.id), '\' ', (lane__soy566.laser_on) ? 'checked=\'checked\'' : '', '/><span class="scb_s_western_blot_choose_gel_type_input_text">Laser</span><input type="checkbox" class="scb_f_microscopy_light" microscopy_id=\'', soy.$$escapeHtml(opt_data.microscopy.id), '\' assignment_id=\'', soy.$$escapeHtml(opt_data.assignment.id), '\' experiment_id=\'', soy.$$escapeHtml(opt_data.experiment.id), '\' ', (lane__soy566.light_on) ? 'checked=\'checked\'' : '', '/><span class="scb_s_western_blot_choose_gel_type_input_text">Light</span><button class=\'scb_f_microscopy_fourx\' microscopy_id=\'', soy.$$escapeHtml(opt_data.microscopy.id), '\' assignment_id=\'', soy.$$escapeHtml(opt_data.assignment.id), '\' experiment_id=\'', soy.$$escapeHtml(opt_data.experiment.id), '\' ', (lane__soy566.mag4_enabled) ? '' : 'disabled=\'disabled\'', '>4x</button><button class=\'scb_f_microscopy_tenx\' microscopy_id=\'', soy.$$escapeHtml(opt_data.microscopy.id), '\' assignment_id=\'', soy.$$escapeHtml(opt_data.assignment.id), '\' experiment_id=\'', soy.$$escapeHtml(opt_data.experiment.id), '\' ', (lane__soy566.mag10_enabled) ? '' : 'disabled=\'disabled\'', '>10x</button><button class=\'scb_f_microscopy_twentyx\' microscopy_id=\'', soy.$$escapeHtml(opt_data.microscopy.id), '\' assignment_id=\'', soy.$$escapeHtml(opt_data.assignment.id), '\' experiment_id=\'', soy.$$escapeHtml(opt_data.experiment.id), '\' ', (lane__soy566.mag20_enabled) ? '' : 'disabled=\'disabled\'', '>20x</button><button class=\'scb_f_microscopy_fortyx\' microscopy_id=\'', soy.$$escapeHtml(opt_data.microscopy.id), '\' assignment_id=\'', soy.$$escapeHtml(opt_data.assignment.id), '\' experiment_id=\'', soy.$$escapeHtml(opt_data.experiment.id), '\' ', (lane__soy566.mag40_enabled) ? '' : 'disabled=\'disabled\'', '>40x</button><button class=\'scb_f_microscopy_sixtyx\' microscopy_id=\'', soy.$$escapeHtml(opt_data.microscopy.id), '\' assignment_id=\'', soy.$$escapeHtml(opt_data.assignment.id), '\' experiment_id=\'', soy.$$escapeHtml(opt_data.experiment.id), '\' ', (lane__soy566.mag60_enabled) ? '' : 'disabled=\'disabled\'', '>60x</button><span class=\'scb_s_microscope_status\'></span><!--<div id=\'scb_s_micro_slide\'><img class=\'circle_lens\' src=\'images/microscopy/circle.png\'/></div>--></div></div>');
  return opt_sb ? '' : output.toString();
};
...
scb_microscopy.display_slide_types = function(opt_data, opt_sb) {
  ...
  if (soy.$$getMapKeys(opt_data.kinds).length == 1) {
    var kList705 = soy.$$getMapKeys(opt_data.kinds);
    var kListLen705 = kList705.length;
    for (var kIndex705 = 0; kIndex705 < kListLen705; kIndex705++) {
      var kData705 = kList705[kIndex705];
      output.append('<span class="scb_f_microscopy_select_slide_type" cell_treatment_id=\'', soy.$$escapeHtml(opt_data.cell_treatment.id), '\' microscopy_id=\'', soy.$$escapeHtml(opt_data.microscopy.id), '\' assignment_id="', soy.$$escapeHtml(opt_data.assignment.id), '" experiment_id="', soy.$$escapeHtml(opt_data.experiment.id), '" value="', soy.$$escapeHtml(kData705), '" lane_kind="', soy.$$escapeHtml(opt_data.lane.kind), '" lane_id="', (opt_data.lane.kind == 'existing') ? soy.$$escapeHtml(opt_data.lane.lane.id) : '', '">', soy.$$escapeHtml(opt_data.kinds[kData705].name), '</span>');
    }
  } else {
    ...
    if (opt_data.lane.kind == 'existing') {
      var kList749 = soy.$$getMapKeys(opt_data.kinds);
      ...
      var kList764 = soy.$$getMapKeys(opt_data.kinds);
      var kListLen764 = kList764.length;
      for (var kIndex764 = 0; kIndex764 < kListLen764; kIndex764++) {
        var kData764 = kList764[kIndex764];
        output.append('<option value=\'', soy.$$escapeHtml(kData764), '\'>', soy.$$escapeHtml(opt_data.kinds[kData764].name), '</option>');
      }
    }
