...
scb_microscopy.display_lens_new = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  var lane__soy570 = new soy.StringBuilder('$microscopy.lanes_list.get($microscopy_line_id)');
  lane__soy570 = lane__soy570.toString();
  output.append('<div class=\'scb_s_microscopy_slide_content\' assignment_id=\'', soy.$$escapeHtml(opt_data.assignment.id), '\' experiment_id=\'', soy.$$escapeHtml(opt_data.experiment.id), '\' microscopy_id=\'', soy.$$escapeHtml(opt_data.microscopy.id), '\'', (opt_data.microscopy_line_id) ? 'microscopy_lane_id=\'' + soy.$$escapeHtml(opt_data.microscopy_line_id) + '\'' : '', '><div id=\'scb_s_microscopy_lens_controls\'><span class=\'scb_s_controls_note\'>Note: Use keyboard arrow keys to navigate lens across the slide.</span><p class = \'scb_space_control\'/>Light<p class = \'scb_space_control\'/><img src=\'images/microscopy/up.jpg\' class =\'scb_s_micro_arrows\' id=\'brightup\'/> <br/><img src =\'images/microscopy/down.jpg\' class =\'scb_s_micro_arrows\'id=\'brightdown\'/><p class = \'scb_space_control\'/>Focus: Rough<p class = \'scb_space_control\'/><img src =\'images/microscopy/up.jpg\' class =\'scb_s_micro_arrows\' id=\'blurup\'/><br/><img src = \'images/microscopy/down.jpg\' class =\'scb_s_micro_arrows\' id=\'blurdown\'/><p class = \'scb_space_control\'/>Focus: Fine<p class = \'scb_space_control\'/><img src = \'images/microscopy/fineup.jpg\' class =\'scb_s_micro_arrows\' id=\'fblurup\'/> <br/><img src = \'images/microscopy/finedown.jpg\' class =\'scb_s_micro_arrows\'id=\'fblurdown\'/><p class = \'scb_space_control\'/><button class=\'scb_s_microscopy_red\' microscopy_id=\'', soy.$$escapeHtml(opt_data.microscopy.id), '\' assignment_id=\'', soy.$$escapeHtml(opt_data.assignment.id), '\' experiment_id=\'', soy.$$escapeHtml(opt_data.experiment.id), '\' ', (lane__soy570.red_enabled) ? '' : 'disabled=\'disabled\'', '>Red</button><button class=\'scb_f_microscopy_blue\' microscopy_id=\'', soy.$$escapeHtml(opt_data.microscopy.id), '\' assignment_id=\'', soy.$$escapeHtml(opt_data.assignment.id), '\' experiment_id=\'', soy.$$escapeHtml(opt_data.experiment.id), '\' ', (lane__soy570.blue_enabled) ? '' : 'disabled=\'disabled\'', '>Blue</button><button class=\'scb_f_microscopy_green\' microscopy_id=\'', soy.$$escapeHtml(opt_data.microscopy.id), '\' assignment_id=\'', soy.$$escapeHtml(opt_data.assignment.id), '\' experiment_id=\'', soy.$$escapeHtml(opt_data.experiment.id), '\' ', (lane__soy570.green_enabled) ? '' : 'disabled=\'disabled\'', '>Green</button><button class=\'scb_f_microscopy_all\' microscopy_id=\'', soy.$$escapeHtml(opt_data.microscopy.id), '\' assignment_id=\'', soy.$$escapeHtml(opt_data.assignment.id), '\' experiment_id=\'', soy.$$escapeHtml(opt_data.experiment.id), '\' ', (lane__soy570.merge_enabled) ? '' : 'disabled=\'disabled\'', '>Merge</button><input type="checkbox" class="scb_f_microscopy_laser" microscopy_id=\'', soy.$$escapeHtml(opt_data.microscopy.id), '\' assignment_id=\'', soy.$$escapeHtml(opt_data.assignment.id), '\' experiment_id=\'', soy.$$escapeHtml(opt_data.experiment.id), '\' ', (lane__soy570.laser_on) ? 'checked=\'checked\'' : '', '/><span class="scb_s_western_blot_choose_gel_type_input_text">Laser</span><input type="checkbox" class="scb_f_microscopy_light" microscopy_id=\'', soy.$$escapeHtml(opt_data.microscopy.id), '\' assignment_id=\'', soy.$$escapeHtml(opt_data.assignment.id), '\' experiment_id=\'', soy.$$escapeHtml(opt_data.experiment.id), '\' ', (lane__soy570.light_on) ? 'checked=\'checked\'' : '', '/><span class="scb_s_western_blot_choose_gel_type_input_text">Light</span><button class=\'scb_f_microscopy_fourx\' microscopy_id=\'', soy.$$escapeHtml(opt_data.microscopy.id), '\' assignment_id=\'', soy.$$escapeHtml(opt_data.assignment.id), '\' experiment_id=\'', soy.$$escapeHtml(opt_data.experiment.id), '\' ', (lane__soy570.mag4_enabled) ? '' : 'disabled=\'disabled\'', '>4x</button><button class=\'scb_f_microscopy_tenx\' microscopy_id=\'', soy.$$escapeHtml(opt_data.microscopy.id), '\' assignment_id=\'', soy.$$escapeHtml(opt_data.assignment.id), '\' experiment_id=\'', soy.$$escapeHtml(opt_data.experiment.id), '\' ', (lane__soy570.mag10_enabled) ? '' : 'disabled=\'disabled\'', '>10x</button><button class=\'scb_f_microscopy_twentyx\' microscopy_id=\'', soy.$$escapeHtml(opt_data.microscopy.id), '\' assignment_id=\'', soy.$$escapeHtml(opt_data.assignment.id), '\' experiment_id=\'', soy.$$escapeHtml(opt_data.experiment.id), '\' ', (lane__soy570.mag20_enabled) ? '' : 'disabled=\'disabled\'', '>20x</button><button class=\'scb_f_microscopy_fortyx\' microscopy_id=\'', soy.$$escapeHtml(opt_data.microscopy.id), '\' assignment_id=\'', soy.$$escapeHtml(opt_data.assignment.id), '\' experiment_id=\'', soy.$$escapeHtml(opt_data.experiment.id), '\' ', (lane__soy570.mag40_enabled) ? '' : 'disabled=\'disabled\'', '>40x</button><button class=\'scb_f_microscopy_sixtyx\' microscopy_id=\'', soy.$$escapeHtml(opt_data.microscopy.id), '\' assignment_id=\'', soy.$$escapeHtml(opt_data.assignment.id), '\' experiment_id=\'', soy.$$escapeHtml(opt_data.experiment.id), '\' ', (lane__soy570.mag60_enabled) ? '' : 'disabled=\'disabled\'', '>60x</button><span class=\'scb_s_microscope_status\'></span><!--<div id=\'scb_s_micro_slide\'><img class=\'circle_lens\' src=\'images/microscopy/circle.png\'/></div>--></div></div>');
  return opt_sb ? '' : output.toString();
};
...
scb_microscopy.display_slide_types = function(opt_data, opt_sb) {
  ...
  if (soy.$$getMapKeys(opt_data.kinds).length == 1) {
    var kList709 = soy.$$getMapKeys(opt_data.kinds);
    var kListLen709 = kList709.length;
    for (var kIndex709 = 0; kIndex709 < kListLen709; kIndex709++) {
      var kData709 = kList709[kIndex709];
      output.append('<span class="scb_f_microscopy_select_slide_type" cell_treatment_id=\'', soy.$$escapeHtml(opt_data.cell_treatment.id), '\' microscopy_id=\'', soy.$$escapeHtml(opt_data.microscopy.id), '\' assignment_id="', soy.$$escapeHtml(opt_data.assignment.id), '" experiment_id="', soy.$$escapeHtml(opt_data.experiment.id), '" value="', soy.$$escapeHtml(kData709), '" lane_kind="', soy.$$escapeHtml(opt_data.lane.kind), '" lane_id="', (opt_data.lane.kind == 'existing') ? soy.$$escapeHtml(opt_data.lane.lane.id) : '', '">', soy.$$escapeHtml(opt_data.kinds[kData709].name), '</span>');
    }
  } else {
    ...
    if (opt_data.lane.kind == 'existing') {
      var kList753 = soy.$$getMapKeys(opt_data.kinds);
      var kListLen753 = kList753.length;
      for (var kIndex753 = 0; kIndex753 < kListLen753; kIndex753++) {
        var kData753 = kList753[kIndex753];
        output.append('<option value=\'', soy.$$escapeHtml(kData753), '\'', (opt_data.lane.lane.kind == kData753) ? 'selected="selected"' : '', '>', soy.$$escapeHtml(opt_data.kinds[kData753].name), '</option>');
      }
    } else {
      ...
      var kList768 = soy.$$getMapKeys(opt_data.kinds);
      var kListLen768 = kList768.length;
      for (var kIndex768 = 0; kIndex768 < kListLen768; kIndex768++) {
        var kData768 = kList768[kIndex768];
        output.append('<option value=\'', soy.$$escapeHtml(kData768), '\'>', soy.$$escapeHtml(opt_data.kinds[kData768].name), '</option>');
      }
    }
