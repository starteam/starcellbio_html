  ...
  if (soy.$$getMapKeys(opt_data.kinds).length == 1) {
    ...
    if (opt_data.lane.kind == 'existing') {
      if (opt_data.lane.cell_treatment.cell_line == opt_data.assignment.template.model.microscopy.valid[0] && opt_data.lane.cell_treatment.treatment_list.list[0].drug_list.list[0].drug_id == opt_data.assignment.template.model.microscopy.valid[1]) {
        var kList696 = soy.$$getMapKeys(opt_data.assignment.template.slide_parser[opt_data.lane.cell_treatment.treatment_list.list[0].collection_id]);
        var kListLen696 = kList696.length;
        for (var kIndex696 = 0; kIndex696 < kListLen696; kIndex696++) {
          var kData696 = kList696[kIndex696];
          output.append('<option value=\'', soy.$$escapeHtml(kData696), '\'', (opt_data.lane.lane.kind == kData696) ? 'selected="selected"' : '', '>', soy.$$escapeHtml(opt_data.kinds[kData696].name), '</option>');
        }
      } else {
        var kList708 = soy.$$getMapKeys(opt_data.assignment.template.slide_parser['default']);
        var kListLen708 = kList708.length;
        for (var kIndex708 = 0; kIndex708 < kListLen708; kIndex708++) {
          var kData708 = kList708[kIndex708];
          output.append('<option value=\'', soy.$$escapeHtml(kData708), '\'', (opt_data.lane.lane.kind == kData708) ? 'selected="selected"' : '', '>', soy.$$escapeHtml(opt_data.kinds[kData708].name), '</option>');
        }
      }
    } else {
      ...
      if (opt_data.lane.cell_treatment.cell_line == opt_data.assignment.template.model.microscopy.valid[0] && opt_data.lane.cell_treatment.treatment_list.list[0].drug_list.list[0].drug_id == opt_data.assignment.template.model.microscopy.valid[1]) {
        var kList725 = soy.$$getMapKeys(opt_data.assignment.template.slide_parser[opt_data.lane.cell_treatment.treatment_list.list[0].collection_id]);
        var kListLen725 = kList725.length;
        for (var kIndex725 = 0; kIndex725 < kListLen725; kIndex725++) {
          var kData725 = kList725[kIndex725];
          output.append('<option value=\'', soy.$$escapeHtml(kData725), '\'>', soy.$$escapeHtml(opt_data.kinds[kData725].name), '</option>');
        }
      } else {
        var kList733 = soy.$$getMapKeys(opt_data.assignment.template.slide_parser['default']);
        var kListLen733 = kList733.length;
        for (var kIndex733 = 0; kIndex733 < kListLen733; kIndex733++) {
          var kData733 = kList733[kIndex733];
          output.append('<option value=\'', soy.$$escapeHtml(kData733), '\'>', soy.$$escapeHtml(opt_data.kinds[kData733].name), '</option>');
        }
      }
    }
