  ...
  if (soy.$$getMapKeys(opt_data.kinds).length == 1) {
    ...
    if (opt_data.lane.kind == 'existing') {
      if (opt_data.lane.cell_treatment.cell_line == opt_data.assignment.template.model.microscopy.valid[0] && opt_data.lane.cell_treatment.treatment_list.list[0].drug_list.list[0].drug_id == opt_data.assignment.template.model.microscopy.valid[1]) {
        var kList826 = soy.$$getMapKeys(opt_data.assignment.template.slide_parser[opt_data.lane.cell_treatment.treatment_list.list[0].collection_id]);
        var kListLen826 = kList826.length;
        for (var kIndex826 = 0; kIndex826 < kListLen826; kIndex826++) {
          var kData826 = kList826[kIndex826];
          output.append('<option value=\'', soy.$$escapeHtml(kData826), '\'', (opt_data.lane.lane.kind == kData826) ? 'selected="selected"' : '', '>', soy.$$escapeHtml(opt_data.kinds[kData826].name), '</option>');
        }
      } else {
        var kList838 = soy.$$getMapKeys(opt_data.assignment.template.slide_parser['default']);
        var kListLen838 = kList838.length;
        for (var kIndex838 = 0; kIndex838 < kListLen838; kIndex838++) {
          var kData838 = kList838[kIndex838];
          output.append('<option value=\'', soy.$$escapeHtml(kData838), '\'', (opt_data.lane.lane.kind == kData838) ? 'selected="selected"' : '', '>', soy.$$escapeHtml(opt_data.kinds[kData838].name), '</option>');
        }
      }
    } else {
      ...
      if (opt_data.lane.cell_treatment.cell_line == opt_data.assignment.template.model.microscopy.valid[0] && opt_data.lane.cell_treatment.treatment_list.list[0].drug_list.list[0].drug_id == opt_data.assignment.template.model.microscopy.valid[1]) {
        var kList855 = soy.$$getMapKeys(opt_data.assignment.template.slide_parser[opt_data.lane.cell_treatment.treatment_list.list[0].collection_id]);
        ...
        var kList863 = soy.$$getMapKeys(opt_data.assignment.template.slide_parser['default']);
        var kListLen863 = kList863.length;
        for (var kIndex863 = 0; kIndex863 < kListLen863; kIndex863++) {
          var kData863 = kList863[kIndex863];
          output.append('<option value=\'', soy.$$escapeHtml(kData863), '\'>', soy.$$escapeHtml(opt_data.kinds[kData863].name), '</option>');
        }
      }
    }
