...
scb_assignments.display_assignment = function(opt_data, opt_sb) {
  ...
  if (opt_data.assignments.selected != null) {
    ...
    output.append('<div class=\'scb_s_assignments_bottom_scroll\'><img class = \'scb_s_assignment_header_img_left scb_assignments_bottom_arrow_left\'  assignment_id=\'', soy.$$escapeHtml(opt_data.assignments.selected.id), '\'  src=\'../../images/homepage/scb_gray_left_arrow_inactive.png\' role=\'button\' aria-label=\'Move one section to the left\'><img class = \'scb_s_assignment_header_img_right scb_assignments_bottom_arrow_right\'  assignment_id=\'', soy.$$escapeHtml(opt_data.assignments.selected.id), '\'  src=\'../../images/homepage/scb_gray_right_arrow_active.png\' role=\'button\' aria-label=\'Move one section to the right\'></div></div><br/><span class="scb_assignments_new_experiment scb_f_open_experiment scb_s_navigation_button" href="#view=experiment_design&assignment_id=', soy.$$escapeHtml(opt_data.assignments.selected.id), '" aria-label=\'New Experiment\' role=\'button\'> START EXPERIMENTS &nbsp; <span aria-hidden="true" tabindex="-1">+</span></span>');
  }
  output.append('</div>');
  return opt_sb ? '' : output.toString();
};
