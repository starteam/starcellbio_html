...
scb_assignments.display_assignment = function(opt_data, opt_sb) {
  ...
  if (opt_data.assignments.selected != null) {
    output.append('<div class=\'scb_s_abstract_title\'>', opt_data.assignments.selected.name, '</div><div class=\'scb_s_assignments_slider_header\'><img class = \'scb_s_assignment_header_img_left\' src=\'../../images/homepage/scb_gray_left_arrow_inactive.png\'>');
    ...
    for (var sectionIndex36 = 0; sectionIndex36 < sectionListLen36; sectionIndex36++) {
      ...
      output.append('<div class=\'scb_assignments_header_link_wrapper scb_s_assignments_slider_overview ', (sectionIndex36 == 0) ? 'scb_assignments_header_link_selected' : '', '\' title=\'', soy.$$escapeHtml(sectionData36[0]), '\' value=\'', soy.$$escapeHtml(sectionData36[0]), '\'>', soy.$$escapeHtml(sectionData36[0]), '</div>');
    }
    output.append('<img class = \'scb_s_assignment_header_img_right\'  src=\'../../images/homepage/scb_gray_right_arrow_active.png\'></div><div class=\'scb_s_assignment_scroll\'>');
    ...
    for (var sectionIndex50 = 0; sectionIndex50 < sectionListLen50; sectionIndex50++) {
      ...
      output.append('<div class=\'scb_s_display_section\' style=\'display:', (sectionIndex50 == 0) ? 'block;' : '', '\' value=\'', soy.$$escapeHtml(sectionData50[0]), '\'>', sectionData50[1], '</div>');
    }
    output.append('</div><br/><a class="scb_f_open_experiment scb_s_navigation_button" href="#view=experiment_design&assignment_id=', soy.$$escapeHtml(opt_data.assignments.selected.id), '"> NEW EXPERIMENT &nbsp; <span aria-hidden="true" tabindex="-1">+</span></a>');
  }
  output.append('</div>');
  return opt_sb ? '' : output.toString();
};
