...
scb_assignments.display_assignment = function(opt_data, opt_sb) {
  ...
  if (opt_data.assignments.selected != null) {
    ...
    for (var sectionIndex36 = 0; sectionIndex36 < sectionListLen36; sectionIndex36++) {
      ...
      output.append('<div class=\'scb_assignments_header_link_wrapper scb_s_assignments_slider_overview ', (sectionIndex36 == 0) ? 'scb_assignments_header_link_selected' : '', '\' role=\'link\' title=\'', soy.$$escapeHtml(sectionData36[0]), '\'   value=\'', soy.$$escapeHtml(sectionData36[0]), '\' aria-controls=\'scb_s_assignment_scroll\' aria-atomic=\'true\' >', soy.$$escapeHtml(sectionData36[0]), '</div>');
    }
