...
scb_experiment_setup.display_details = function(opt_data, opt_sb) {
  ...
  if (opt_data.kind == 'readwrite') {
    ...
    output.append('<div class=\'scb_s_warning\'><h1>WARNING!</h1><p>Below is your set up for ', soy.$$escapeHtml(opt_data.experiment.name), '.<br>Once you run your experiment, you can not go bck and make changes to your set-up. Please carefully review the summary of your experimental set-up and then either go back to edit your set-up o click on Confirm Set-up Select Technique button to run your experiment.</p></div><div class=\'scb_s_experiment_setup_video_box_wrapper\'><div class=\'scb_s_experiment_setup_video_box\'></div></div>');
  }
