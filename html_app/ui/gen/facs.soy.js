    ...
    if (opt_data.lane.canvas_metadata_analysis) {
      if (opt_data.lane.canvas_metadata_analysis.ranges) {
        if (opt_data.lane.canvas_metadata_analysis.ranges.length > 0) {
          ...
          var rangeList607 = opt_data.lane.canvas_metadata_analysis.ranges;
          var rangeListLen607 = rangeList607.length;
          for (var rangeIndex607 = 0; rangeIndex607 < rangeListLen607; rangeIndex607++) {
            var rangeData607 = rangeList607[rangeIndex607];
            output.append('<tr role=\'row\'><td><div style=\'background-color:', soy.$$escapeHtml(rangeData607.color), '; width:12px; height:12px\'></div></td><td>', soy.$$escapeHtml(rangeData607.from), ' - ', soy.$$escapeHtml(rangeData607.to), '</td><td>', soy.$$escapeHtml(rangeData607.percentage), '</td><td><img class=\'scb_f_facs_analyze_remove_point\' assignment_id=\'', soy.$$escapeHtml(opt_data.assignment.id), '\' experiment_id=\'', soy.$$escapeHtml(opt_data.experiment.id), '\' facs_id=\'', soy.$$escapeHtml(opt_data.facs.id), '\' facs_lane_id=\'', soy.$$escapeHtml(opt_data.lane.id), '\' from=\'', soy.$$escapeHtml(rangeData607.from), '\' to=\'', soy.$$escapeHtml(rangeData607.to), '\' alt="Delete" title="Delete" src="images/setup/scb_remove.png"></td></tr>');
          }
