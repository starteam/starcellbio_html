  ...
  if (soy.$$getMapKeys(opt_data.kinds).length == 1) {
    ...
    if (opt_data.lane.kind == 'existing') {
      ...
      for (var kIndex418 = 0; kIndex418 < kListLen418; kIndex418++) {
        ...
        output.append('<option value=\'', soy.$$escapeHtml(kData418), '\' role=\'option\'', (opt_data.lane.lane.kind == kData418) ? 'selected="selected"' : '', '>', soy.$$escapeHtml(opt_data.kinds[kData418].name), '</option>');
      }
    } else {
      ...
      for (var kIndex433 = 0; kIndex433 < kListLen433; kIndex433++) {
        ...
        output.append('<option role=\'option\' value=\'', soy.$$escapeHtml(kData433), '\'>', soy.$$escapeHtml(opt_data.kinds[kData433].name), '</option>');
      }
    }
