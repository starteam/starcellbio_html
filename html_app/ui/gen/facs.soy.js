...
scb_facs.display_lysate_types = function(opt_data, opt_sb) {
  ...
  if (soy.$$getMapKeys(opt_data.kinds).length == 1) {
    ...
    if (opt_data.lane.kind == 'existing') {
      var kList513 = soy.$$getMapKeys(opt_data.kinds);
      var kListLen513 = kList513.length;
      for (var kIndex513 = 0; kIndex513 < kListLen513; kIndex513++) {
        var kData513 = kList513[kIndex513];
        output.append('<option value=\'', soy.$$escapeHtml(kData513), '\' role=\'option\'', (opt_data.lane.lane.kind == kData513) ? 'selected="selected"' : '', '>', soy.$$escapeHtml(opt_data.kinds[kData513].name), '</option>');
      }
    } else {
      ...
      var kList528 = soy.$$getMapKeys(opt_data.kinds);
      var kListLen528 = kList528.length;
      for (var kIndex528 = 0; kIndex528 < kListLen528; kIndex528++) {
        var kData528 = kList528[kIndex528];
        output.append('<option role=\'option\' value=\'', soy.$$escapeHtml(kData528), '\'>', soy.$$escapeHtml(opt_data.kinds[kData528].name), '</option>');
      }
    }
...
scb_facs.analyze = function(opt_data, opt_sb) {
  ...
  var rList573 = opt_data.rows;
  var rListLen573 = rList573.length;
  for (var rIndex573 = 0; rIndex573 < rListLen573; rIndex573++) {
    var rData573 = rList573[rIndex573];
    output.append((rData573.is_valid) ? (rData573.index == 0) ? '<li role=\'listitem\' facs_id=\'' + soy.$$escapeHtml(opt_data.facs.id) + '\' assignment_id="' + soy.$$escapeHtml(opt_data.assignment.id) + '" experiment_id="' + soy.$$escapeHtml(opt_data.experiment.id) + '" facs_lane_id=\'' + soy.$$escapeHtml(rData573.lane.id) + '\' lane_kind = \'' + soy.$$escapeHtml(rData573.lane.kind) + '\' conditions = \'' + soy.$$escapeHtml(rData573.lane.conditions) + '\' title=\'' + soy.$$escapeHtml(rData573.display_text) + '\'' + ((opt_data.facs.selected_lane && rData573.cell_treatment.id == opt_data.facs.selected_lane.cell_treatment_id) ? 'class=\'scb_s_facs_sample_selected\'' : '') + '>&nbsp;&nbsp;' + soy.$$escapeHtml(rData573.display_text) + '</li>' : '' : '');
  }
  ...
  if (opt_data.facs.samples_finished) {
    var rList620 = opt_data.rows;
    var rListLen620 = rList620.length;
    for (var rIndex620 = 0; rIndex620 < rListLen620; rIndex620++) {
      var rData620 = rList620[rIndex620];
      output.append((rData620.is_valid && rData620.lane.id == opt_data.facs.selected_lane.id) ? '<span class=\'scb_s_western_blot_gel_active scb_s_western_blot_gel_tab \' role=\'tab\'><div class=\'scb_s_facs_gel_tab_selected\'>' + soy.$$escapeHtml(opt_data.facs.selected_lane.kinds[opt_data.facs.selected_lane.kind].conditions[opt_data.facs.selected_lane.conditions].name) + '</div></span>' : (rData620.is_valid && rData620.cell_treatment.id == opt_data.facs.selected_lane.cell_treatment_id) ? '<div class=\'scb_s_western_blot_gel_tab\' facs_id=\'' + soy.$$escapeHtml(opt_data.facs.id) + '\' assignment_id=\'' + soy.$$escapeHtml(opt_data.assignment.id) + '\' role=\'tab\' experiment_id=\'' + soy.$$escapeHtml(opt_data.experiment.id) + '\' facs_lane_id=\'' + soy.$$escapeHtml(rData620.lane.id) + '\'>' + soy.$$escapeHtml(rData620.lane.kinds[rData620.lane.kind].conditions[rData620.lane.conditions].name) + '</div>' : '');
    }
  } else {
    ...
    if (opt_data.lane.canvas_metadata_analysis) {
      if (opt_data.lane.canvas_metadata_analysis.ranges) {
        if (opt_data.lane.canvas_metadata_analysis.ranges.length > 0) {
          ...
          var rangeList734 = opt_data.lane.canvas_metadata_analysis.ranges;
          var rangeListLen734 = rangeList734.length;
          for (var rangeIndex734 = 0; rangeIndex734 < rangeListLen734; rangeIndex734++) {
            var rangeData734 = rangeList734[rangeIndex734];
            output.append('<tr role=\'row\'><td class="', (rangeData734.bisector_id == 'b') ? 'scb_s_facs_tools_analyze_bisector_border' : '', '">', soy.$$escapeHtml(rangeData734.display_id), '</td><td class="', (rangeData734.bisector_id == 'b') ? 'scb_s_facs_tools_analyze_bisector_border' : '', '">', soy.$$escapeHtml(rangeData734.bisector_id), '</td><td class="', (rangeData734.bisector_id == 'b') ? 'scb_s_facs_tools_analyze_bisector_border' : '', '">', soy.$$escapeHtml(rangeData734.from), ' - ', soy.$$escapeHtml(rangeData734.to), '</td><td class="', (rangeData734.bisector_id == 'b') ? 'scb_s_facs_tools_analyze_bisector_border' : '', '">', soy.$$escapeHtml(rangeData734.percentage), '</td><td class="', (rangeData734.bisector_id == 'b') ? 'scb_s_facs_tools_analyze_bisector_border' : '', '"><img class=\'scb_f_facs_analyze_remove_point scb_s_facs_analyze_remove_point\' assignment_id=\'', soy.$$escapeHtml(opt_data.assignment.id), '\' experiment_id=\'', soy.$$escapeHtml(opt_data.experiment.id), '\' facs_id=\'', soy.$$escapeHtml(opt_data.facs.id), '\' facs_lane_id=\'', soy.$$escapeHtml(opt_data.lane.id), '\' from=\'', soy.$$escapeHtml(rangeData734.from), '\' to=\'', soy.$$escapeHtml(rangeData734.to), '\' alt="Delete" title="Delete" src="images/setup/scb_remove.png"></td></tr>');
          }
