...
scb_facs.sample_prep = function(opt_data, opt_sb) {
  ...
  for (var rIndex264 = 0; rIndex264 < rListLen264; rIndex264++) {
    ...
    output.append('<tr class=\'scb_s_facs_samples_table_tr \'  role=\'row\' ><td class=\'scb_s_facs_samples_table_td scb_s_experiment_setup_table_border\' style=\'width:56px;\'>', (rData264.display_sample) ? '<input  type="checkbox" class="scb_f_facs_sample_active" facs_id=\'' + soy.$$escapeHtml(opt_data.facs.id) + '\'  aria-checked=\'' + ((rData264.is_sample_enabled) ? 'true' : 'false') + '\' assignment_id=\'' + soy.$$escapeHtml(opt_data.assignment.id) + '\' experiment_id=\'' + soy.$$escapeHtml(opt_data.experiment.id) + '\' cell_treatment_id=\'' + soy.$$escapeHtml(rData264.cell_treatment.id) + '\'  role=\'checkbox\'' + ((rData264.is_sample_enabled) ? 'checked="checked"' : '') + '>' : '', '</td> ', (rData264.kind == 'existing' && soy.$$getMapKeys(opt_data.kinds).length > 1) ? '' : '', '<td class=\'scb_s_facs_samples_table_td scb_s_experiment_setup_table_border\' style="', (rData264.kind == 'existing' && soy.$$getMapKeys(opt_data.kinds).length > 1) ? 'width:230px;' : 'width:224px;', '">', (rData264.display_sample) ? soy.$$escapeHtml(rData264.display_text) : '', '</td><td class=\'scb_s_facs_samples_table_td scb_s_experiment_setup_table_border scb_s_facs_cell_treatment\' style="', (rData264.kind == 'existing' && soy.$$getMapKeys(opt_data.kinds).length > 1) ? 'width:171px;' : 'width:136px;', '">', (rData264.is_sample_enabled) ? '<input type="radio"  checked class=\'scb_s_facs_cell_treatment_radio facs_locked\'><span class=\'scb_s_facs_cell_treatment_text ' + ((rData264.is_sample_enabled) ? 'facs_locked' : 'scb_s_microscopy_dim_conditions') + '\'>Fixed</span></input>' : '<input type="radio"  class=\'scb_s_facs_cell_treatment_radio facs_locked\'><span class=\'scb_s_facs_cell_treatment_text ' + ((rData264.is_sample_enabled) ? 'facs_locked' : 'scb_s_microscopy_dim_conditions') + '\'>Fixed</span></input>', '</td><td class=\' scb_s_facs_samples_table_td scb_s_experiment_setup_table_border\' style=\'width:215px;\'>');
    ...
    output.append('</td><td class=\' scb_s_facs_samples_table_td scb_s_experiment_setup_table_border\' style=\'width:232px;\'>', (rData264.lane && soy.$$getMapKeys(opt_data.kinds).length > 1) ? (rData264.lane.kind == 'Dye') ? '<input class="scb_f_microscopy_select_conditions" facs_id=\'' + soy.$$escapeHtml(opt_data.facs.id) + '\' assignment_id=\'' + soy.$$escapeHtml(opt_data.assignment.id) + '\' experiment_id=\'' + soy.$$escapeHtml(opt_data.experiment.id) + '\' type="radio" value="whole" cell_treatment_id=\'' + soy.$$escapeHtml(rData264.cell_treatment.id) + '\' lane_kind="' + soy.$$escapeHtml(rData264.kind) + '" lane_id="' + ((rData264.kind == 'existing') ? soy.$$escapeHtml(rData264.lane.id) : '') + '"' + ((rData264.is_sample_enabled) ? 'checked="checked"' : '') + ' /><span class="scb_s_western_blot_choose_gel_type_input_text ">' + soy.$$escapeHtml(opt_data.assignment.template.facs_kinds.Dye.conditions.whole.name) + '</span>' : (rData264.lane.kind == 'Anti') ? '<input class="scb_f_microscopy_select_conditions" facs_id=\'' + soy.$$escapeHtml(opt_data.facs.id) + '\' assignment_id=\'' + soy.$$escapeHtml(opt_data.assignment.id) + '\' experiment_id=\'' + soy.$$escapeHtml(opt_data.experiment.id) + '\' type="radio" value="a" cell_treatment_id=\'' + soy.$$escapeHtml(rData264.cell_treatment.id) + '\' lane_kind="' + soy.$$escapeHtml(rData264.kind) + '" lane_id="' + ((rData264.kind == 'existing') ? soy.$$escapeHtml(rData264.lane.id) : '') + '"' + ((rData264.is_sample_enabled) ? 'checked="checked"' : '') + ' /><span class="scb_s_western_blot_choose_gel_type_input_text ">' + soy.$$escapeHtml(opt_data.assignment.template.facs_kinds.Anti.conditions.a.name) + '</span>' : '' : '', '</td><td class=\'scb_s_facs_samples_table_td scb_s_experiment_setup_table_border\'>', (rData264.kind == 'existing' && soy.$$getMapKeys(opt_data.kinds).length > 1) ? '<button class="scb_f_facs_sample_remove" facs_id=\'' + soy.$$escapeHtml(opt_data.facs.id) + '\' assignment_id=\'' + soy.$$escapeHtml(opt_data.assignment.id) + '\' experiment_id=\'' + soy.$$escapeHtml(opt_data.experiment.id) + '\' lane_id=\'' + soy.$$escapeHtml(rData264.lane.id) + '\' role=\'button\' aria-label=\'Delete Sample\'' + ((rData264.is_sample_enabled) ? '' : 'disabled="disabled"') + '><img alt="Delete" title="Delete" src="images/setup/scb_remove.png"></button>' : '<!--<button class="scb_f_facs_sample_remove" role=\'button\' aria-label=\'Close Tab\' disabled="disabled">&#215;</button>-->', '</td></tr>');
  }
...
scb_facs.display_lysate_types = function(opt_data, opt_sb) {
  ...
  if (soy.$$getMapKeys(opt_data.kinds).length == 1) {
    ...
    if (opt_data.lane.kind == 'existing') {
      var kList491 = soy.$$getMapKeys(opt_data.kinds);
      var kListLen491 = kList491.length;
      for (var kIndex491 = 0; kIndex491 < kListLen491; kIndex491++) {
        var kData491 = kList491[kIndex491];
        output.append('<option value=\'', soy.$$escapeHtml(kData491), '\' role=\'option\'', (opt_data.lane.lane.kind == kData491) ? 'selected="selected"' : '', '>', soy.$$escapeHtml(opt_data.kinds[kData491].name), '</option>');
      }
    } else {
      ...
      var kList506 = soy.$$getMapKeys(opt_data.kinds);
      var kListLen506 = kList506.length;
      for (var kIndex506 = 0; kIndex506 < kListLen506; kIndex506++) {
        var kData506 = kList506[kIndex506];
        output.append('<option role=\'option\' value=\'', soy.$$escapeHtml(kData506), '\'>', soy.$$escapeHtml(opt_data.kinds[kData506].name), '</option>');
      }
    }
...
scb_facs.analyze = function(opt_data, opt_sb) {
  ...
  var rList551 = opt_data.rows;
  var rListLen551 = rList551.length;
  for (var rIndex551 = 0; rIndex551 < rListLen551; rIndex551++) {
    var rData551 = rList551[rIndex551];
    output.append((rData551.is_valid) ? (rData551.index == 0) ? '<li role=\'listitem\' facs_id=\'' + soy.$$escapeHtml(opt_data.facs.id) + '\' assignment_id="' + soy.$$escapeHtml(opt_data.assignment.id) + '" experiment_id="' + soy.$$escapeHtml(opt_data.experiment.id) + '" facs_lane_id=\'' + soy.$$escapeHtml(rData551.lane.id) + '\' lane_kind = \'' + soy.$$escapeHtml(rData551.lane.kind) + '\' conditions = \'' + soy.$$escapeHtml(rData551.lane.conditions) + '\' title=\'' + soy.$$escapeHtml(rData551.display_text) + '\'' + ((opt_data.facs.selected_lane && rData551.cell_treatment.id == opt_data.facs.selected_lane.cell_treatment_id) ? 'class=\'scb_s_facs_sample_selected\'' : '') + '>&nbsp;&nbsp;' + soy.$$escapeHtml(rData551.display_text) + '</li>' : '' : '');
  }
    ...
    if (opt_data.lane.canvas_metadata_analysis) {
      if (opt_data.lane.canvas_metadata_analysis.ranges) {
        if (opt_data.lane.canvas_metadata_analysis.ranges.length > 0) {
          ...
          var rangeList712 = opt_data.lane.canvas_metadata_analysis.ranges;
          var rangeListLen712 = rangeList712.length;
          for (var rangeIndex712 = 0; rangeIndex712 < rangeListLen712; rangeIndex712++) {
            var rangeData712 = rangeList712[rangeIndex712];
            output.append('<tr role=\'row\'><td class="', (rangeData712.bisector_id == 'b') ? 'scb_s_facs_tools_analyze_bisector_border' : '', '">', soy.$$escapeHtml(rangeData712.display_id), '</td><td class="', (rangeData712.bisector_id == 'b') ? 'scb_s_facs_tools_analyze_bisector_border' : '', '">', soy.$$escapeHtml(rangeData712.bisector_id), '</td><td class="', (rangeData712.bisector_id == 'b') ? 'scb_s_facs_tools_analyze_bisector_border' : '', '">', soy.$$escapeHtml(rangeData712.from), ' - ', soy.$$escapeHtml(rangeData712.to), '</td><td class="', (rangeData712.bisector_id == 'b') ? 'scb_s_facs_tools_analyze_bisector_border' : '', '">', soy.$$escapeHtml(rangeData712.percentage), '</td><td class="', (rangeData712.bisector_id == 'b') ? 'scb_s_facs_tools_analyze_bisector_border' : '', '"><img class=\'scb_f_facs_analyze_remove_point scb_s_facs_analyze_remove_point\' assignment_id=\'', soy.$$escapeHtml(opt_data.assignment.id), '\' experiment_id=\'', soy.$$escapeHtml(opt_data.experiment.id), '\' facs_id=\'', soy.$$escapeHtml(opt_data.facs.id), '\' facs_lane_id=\'', soy.$$escapeHtml(opt_data.lane.id), '\' from=\'', soy.$$escapeHtml(rangeData712.from), '\' to=\'', soy.$$escapeHtml(rangeData712.to), '\' alt="Delete" title="Delete" src="images/setup/scb_remove.png"></td></tr>');
          }
