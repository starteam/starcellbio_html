...
scb_facs.analyze = function(opt_data, opt_sb) {
  ...
  if (opt_data.facs.samples_finished) {
    var rList625 = opt_data.rows;
    var rListLen625 = rList625.length;
    for (var rIndex625 = 0; rIndex625 < rListLen625; rIndex625++) {
      var rData625 = rList625[rIndex625];
      output.append((rData625.is_valid && rData625.lane.id == opt_data.facs.selected_lane.id) ? '<span class=\'scb_s_western_blot_gel_active scb_s_western_blot_gel_tab \' role=\'tab\'><div class=\'scb_s_facs_gel_tab_selected\'>' + soy.$$escapeHtml(opt_data.facs.selected_lane.kinds[opt_data.facs.selected_lane.kind].conditions[opt_data.facs.selected_lane.conditions].name) + '</div></span>' : (rData625.is_valid && rData625.cell_treatment.id == opt_data.facs.selected_lane.cell_treatment_id) ? '<div class=\'scb_s_western_blot_gel_tab\' facs_id=\'' + soy.$$escapeHtml(opt_data.facs.id) + '\' assignment_id=\'' + soy.$$escapeHtml(opt_data.assignment.id) + '\' role=\'tab\' experiment_id=\'' + soy.$$escapeHtml(opt_data.experiment.id) + '\' facs_lane_id=\'' + soy.$$escapeHtml(rData625.lane.id) + '\'>' + soy.$$escapeHtml(rData625.lane.kinds[rData625.lane.kind].conditions[rData625.lane.conditions].name) + '</div>' : '');
    }
  } else {
    ...
    if (opt_data.lane.canvas_metadata_analysis) {
      if (opt_data.lane.canvas_metadata_analysis.ranges) {
        if (opt_data.lane.canvas_metadata_analysis.ranges.length > 0) {
          ...
          var rangeList744 = opt_data.lane.canvas_metadata_analysis.ranges;
          var rangeListLen744 = rangeList744.length;
          for (var rangeIndex744 = 0; rangeIndex744 < rangeListLen744; rangeIndex744++) {
            var rangeData744 = rangeList744[rangeIndex744];
            output.append('<tr role=\'row\'><td class="', (rangeData744.bisector_id == 'b') ? 'scb_s_facs_tools_analyze_bisector_border' : '', '">', soy.$$escapeHtml(rangeData744.display_id), '</td><td class="', (rangeData744.bisector_id == 'b') ? 'scb_s_facs_tools_analyze_bisector_border' : '', '">', soy.$$escapeHtml(rangeData744.bisector_id), '</td><td class="', (rangeData744.bisector_id == 'b') ? 'scb_s_facs_tools_analyze_bisector_border' : '', '">', soy.$$escapeHtml(rangeData744.from), ' - ', soy.$$escapeHtml(rangeData744.to), '</td><td class="', (rangeData744.bisector_id == 'b') ? 'scb_s_facs_tools_analyze_bisector_border' : '', '">', soy.$$escapeHtml(rangeData744.percentage), '</td><td class="', (rangeData744.bisector_id == 'b') ? 'scb_s_facs_tools_analyze_bisector_border' : '', '"><img class=\'scb_f_facs_analyze_remove_point scb_s_facs_analyze_remove_point\' assignment_id=\'', soy.$$escapeHtml(opt_data.assignment.id), '\' experiment_id=\'', soy.$$escapeHtml(opt_data.experiment.id), '\' facs_id=\'', soy.$$escapeHtml(opt_data.facs.id), '\' facs_lane_id=\'', soy.$$escapeHtml(opt_data.lane.id), '\' from=\'', soy.$$escapeHtml(rangeData744.from), '\' to=\'', soy.$$escapeHtml(rangeData744.to), '\' alt="Delete" title="Delete" src="images/setup/scb_remove.png"></td></tr>');
          }
