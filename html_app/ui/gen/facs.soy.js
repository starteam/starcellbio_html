...
scb_facs.display_graph = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<div class=\'scb_s_western_blot_gel_content\'><div class=\'scb_s_facs_chart_wrapper\'><div class=\'scb_s_facs_chart_xaxis\'>PI Fluorescence</div><div class=\'scb_s_facs_chart_yaxis\'>Number of cells (thousands)</div><div class=\'scb_s_facs_chart\' assignment_id=\'', soy.$$escapeHtml(opt_data.assignment.id), '\' experiment_id=\'', soy.$$escapeHtml(opt_data.experiment.id), '\' facs_id=\'', soy.$$escapeHtml(opt_data.facs.id), '\'', (opt_data.facs_line_id) ? 'facs_lane_id=\'' + soy.$$escapeHtml(opt_data.facs_line_id) + '\'' : '', '></div></div><div class=\'scb_s_facs_tools\'>');
  if (opt_data.facs.sample_analysis) {
    output.append('<h1>Flow Cytometry Analysis</h1><button class=\'scb_s_facs_tools_instructions_followup_toggle\'>Click here to hide instructions</button><div class=\'scb_s_facs_tools_instructions_followup\'><ul><li>The flow cytometry analysis tool will divide the flow cytometry plot into segments and calculate the percentage of cells that are found within each segment of your plot.</li><li>To analyze your data, click within the flow cytometry experimental results graph at the position where you would like to create a segment. The tool will vertically divide the graph into segments at that position and display the percentage of cells that are within each section of your plot below. Create another segment by clicking at the next position at which you would like to create another segment.</li><li>To delete a particular data analysis point, click the \'x\' to the right �</li><li>To alter the position of the segment, click on the numerical value below and type the desired position of the segment in terms of levels of PI Fluorescence.</li></ul></div>');
      ...
      if (opt_data.lane.canvas_metadata_analysis.ranges) {
        if (opt_data.lane.canvas_metadata_analysis.ranges.length > 0) {
          ...
          for (var rangeIndex309 = 0; rangeIndex309 < rangeListLen309; rangeIndex309++) {
            ...
            output.append('<tr><td><div style=\'background-color:', soy.$$escapeHtml(rangeData309.color), '; width:12px; height:12px\'></div></td><td>', soy.$$escapeHtml(rangeData309.from), '</td><td>', soy.$$escapeHtml(rangeData309.to), '</td><td>', soy.$$escapeHtml(rangeData309.percentage), '</td><td>', (! (rangeIndex309 == rangeListLen309 - 1)) ? '<img class=\'scb_f_facs_analyze_remove_point\' assignment_id=\'' + soy.$$escapeHtml(opt_data.assignment.id) + '\' experiment_id=\'' + soy.$$escapeHtml(opt_data.experiment.id) + '\' facs_id=\'' + soy.$$escapeHtml(opt_data.facs.id) + '\' facs_lane_id=\'' + soy.$$escapeHtml(opt_data.lane.id) + '\' value=\'' + soy.$$escapeHtml(rangeData309.to) + '\' alt="Delete" title="Delete" src="images/setup/scb_remove.png">' : '', '</td></tr>');
          }
