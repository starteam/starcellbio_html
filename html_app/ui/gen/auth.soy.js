...
scb_auth.signup = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<div class=\'scb_s_signup_dialog\'><div class=\'scb_s_signup_form\'> <div>Sign Up</div><button class=\'scb_f_signup_close_button\'><span>&#215;</span></button></div><iframe src=\'/accounts/signup/\' class=\'iframe\'></iframe></div>');
  return opt_sb ? '' : output.toString();
};
...
scb_auth.logout = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<div class=\'scb_s_logout_dialog\'><button class=\'scb_f_logout_close_button\'><span>&#215;</span></button><button class=\'scb_f_logout_button\'>Logout</button></div>');
  return opt_sb ? '' : output.toString();
};
