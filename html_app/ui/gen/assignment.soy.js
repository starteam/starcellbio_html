...
scb_assignment.display_details = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<div class=\'scb_s_assignment_description\'><h1 class=\'scb_s_assignment_title\'>', opt_data.assignment.name, '</h1><div class=\'scb_s_assignment_title_underline\'></div>', opt_data.assignment.description, opt_data.t.instructions, '<br/><a class="scb_f_open_experiment scb_s_navigation_button" href="#view=experiment_design&assignment_id=', soy.$$escapeHtml(opt_data.assignment.id), '"> DESIGN EXPERIMENT &nbsp; &#9654;</a><a class="scb_f_select_assignment scb_s_navigation_button" href="#view=assignments&assignment_id=', soy.$$escapeHtml(opt_data.assignment.id), '">&#9664; &nbsp; ASSIGNMENT</a></div>');
  return opt_sb ? '' : output.toString();
};
