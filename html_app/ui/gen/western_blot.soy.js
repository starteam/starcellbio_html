...
scb_western_blot.display_lysate_types = function(opt_data, opt_sb) {
  ...
  if (soy.$$getMapKeys(opt_data.kinds).length < 1) {
    var kList477 = soy.$$getMapKeys(opt_data.kinds);
    var kListLen477 = kList477.length;
    for (var kIndex477 = 0; kIndex477 < kListLen477; kIndex477++) {
      var kData477 = kList477[kIndex477];
      output.append('<div class="scb_f_western_blot_select_lysate_type"  kind=\'', soy.$$escapeHtml(kData477), '\' cell_treatment_id=\'', soy.$$escapeHtml(opt_data.cell_treatment.id), '\' western_blot_id=\'', soy.$$escapeHtml(opt_data.western_blot.id), '\' assignment_id="', soy.$$escapeHtml(opt_data.assignment.id), '" experiment_id="', soy.$$escapeHtml(opt_data.experiment.id), '" lane_kind="', soy.$$escapeHtml(opt_data.lane.kind), '" lane_id="', (opt_data.lane.kind == 'existing') ? soy.$$escapeHtml(opt_data.lane.lane.id) : '', '">', soy.$$escapeHtml(opt_data.kinds[kData477].name), '</div>');
    }
  } else {
    if (soy.$$getMapKeys(opt_data.kinds).length == 1) {
      ...
      if (opt_data.lane.kind == 'existing') {
        var kList545 = soy.$$getMapKeys(opt_data.kinds);
        var kListLen545 = kList545.length;
        for (var kIndex545 = 0; kIndex545 < kListLen545; kIndex545++) {
          var kData545 = kList545[kIndex545];
          output.append('<option value=\'', soy.$$escapeHtml(kData545), '\'', (opt_data.lane.lane.kind == kData545) ? 'selected="selected"' : '', '>', soy.$$escapeHtml(opt_data.kinds[kData545].name), '</option>');
        }
      } else {
        ...
        var kList560 = soy.$$getMapKeys(opt_data.kinds);
        var kListLen560 = kList560.length;
        for (var kIndex560 = 0; kIndex560 < kListLen560; kIndex560++) {
          var kData560 = kList560[kIndex560];
          output.append('<option value=\'', soy.$$escapeHtml(kData560), '\'>', soy.$$escapeHtml(opt_data.kinds[kData560].name), '</option>');
        }
      }
