...
scb_western_blot.prepare_gel = function(opt_data, opt_sb) {
  ...
  output.append('<div class=\'scb_s_western_blot_samples_area\'><button class=\'scb_f_info_icon  scb_s_western_blot_gel_type_info\' note=\'scb_f_wb_gel_type_followup\'> </button><div class=\'scb_f_wb_gel_type_followup scb_f_controls_note\'><!--<button class=\'scb_f_controls_close_button\' aria-label=\'Close\'>&#215;</button>-->Gel type refers to the percentage of acrylamide that is used to make the gel. Lower acrylamide concentrations are used to separate large proteins, while high acrylamide concentrations are used to separate small proteins.<a href="static/ref_lib/full_library.html#GelPreparation" target=\'_blank\' class=\'scb_s_select_technique_learn_more \'>Learn more &gt;&gt;</a></div>', (opt_data.western_blot.marker_loaded) ? '' : '<button class=\'scb_f_info_icon scb_s_western_blot_marker_info\' note=\'scb_f_wb_marker_followup\'> </button><div class=\'scb_f_wb_marker_followup scb_f_controls_note\'><!--<button class=\'scb_f_controls_close_button\' aria-label=\'Close\'>&#215;</button>-->A protein marker or ladder consisting of multiple proteins of known sizes is loaded into one of the gel\'s wells that serves as a measurement tool against which you can measure the protein of interest. The protein marker usually consists of wide range of protein sizes, ranging from 10-250 kilodaltons (kDa).<a href="static/ref_lib/full_library.html#LoadGel" target=\'_blank\' class=\'scb_s_select_technique_learn_more \'>Learn more &gt;&gt;</a></div>', '<div class=\'scb_s_western_blot_choose_gel_type\'><!-- TODO: Gel Type stuff --><div class=\'scb_s_western_blot_choose_gel_type_title\'>Gel Type:</div>', (opt_data.western_blot.wells_loaded) ? ((opt_data.western_blot.gel_type == '.10') ? '&nbsp;&nbsp;&nbsp;10%' : '') + ((opt_data.western_blot.gel_type == '.12') ? '&nbsp;&nbsp;&nbsp;12%' : '') + ((opt_data.western_blot.gel_type == '.15') ? '&nbsp;&nbsp;&nbsp;15%' : '') : '<input class=\'scb_s_western_blot_choose_gel_type_input\' type="radio" name="gel_type" value=".10" western_blot_id=\'' + soy.$$escapeHtml(opt_data.western_blot.id) + '\' assignment_id=\'' + soy.$$escapeHtml(opt_data.assignment.id) + '\' experiment_id=\'' + soy.$$escapeHtml(opt_data.experiment.id) + '\' ' + ((opt_data.western_blot.gel_type == '.10') ? 'checked=\'checked\'' : '') + '/><span class="scb_s_western_blot_choose_gel_type_input_text">10%</span>&nbsp;&nbsp;<!--<input class=\'scb_s_western_blot_choose_gel_type_input\' type="radio" name="gel_type" value=".12" western_blot_id=\'' + soy.$$escapeHtml(opt_data.western_blot.id) + '\' assignment_id=\'' + soy.$$escapeHtml(opt_data.assignment.id) + '\' experiment_id=\'' + soy.$$escapeHtml(opt_data.experiment.id) + '\' ' + ((opt_data.western_blot.gel_type == '.12') ? 'checked=\'checked\'' : '') + ' /><span class="scb_s_western_blot_choose_gel_type_input_text ">12%</span>&nbsp;<input class=\'scb_s_western_blot_choose_gel_type_input\' type="radio" name="gel_type" value=".15" western_blot_id=\'' + soy.$$escapeHtml(opt_data.western_blot.id) + '\' assignment_id=\'' + soy.$$escapeHtml(opt_data.assignment.id) + '\' experiment_id=\'' + soy.$$escapeHtml(opt_data.experiment.id) + '\' ' + ((opt_data.western_blot.gel_type == '.15') ? 'checked=\'checked\'' : '') + ' /><span class="scb_s_western_blot_choose_gel_type_input_text ">15%</span>-->', '</div><div class=\'scb_s_western_blot_samples_heading\'>Samples', (opt_data.western_blot.wells_loaded == false) ? '<button class=\'scb_f_western_blot_tools_toggle scb_s_western_blot_tools_samples_followup_toggle\'  note=\'scb_s_western_blot_tools_samples_followup\' assignment_id=\'' + soy.$$escapeHtml(opt_data.assignment.id) + '\' experiment_id=\'' + soy.$$escapeHtml(opt_data.experiment.id) + '\' western_blot_id=\'' + soy.$$escapeHtml(opt_data.western_blot.id) + '\'></button><div class=\'scb_s_western_blot_tools_samples_followup ' + ((opt_data.western_blot.samples_show_state) ? '' : 'scb_s_hidden_note') + '\' ><button class=\'scb_f_western_blot_note_close_button\' aria-label=\'Close\' note=\'scb_s_western_blot_tools_samples_followup\' assignment_id=\'' + soy.$$escapeHtml(opt_data.assignment.id) + '\' experiment_id=\'' + soy.$$escapeHtml(opt_data.experiment.id) + '\' western_blot_id=\'' + soy.$$escapeHtml(opt_data.western_blot.id) + '\'><span>&#215;</span></button>To re-order the samples, either (1) click and drag the samples or (2) select a sample and use the up and down arrows to move the samples into the desired order.</div><span class=\'scb_s_wb_button_wrapper\'><button class=\'scb_f_wb_up_button\'>&#x25B2;</button>&nbsp;<button class=\'scb_f_wb_down_button\'>&#x25BC;</button></span><br/><br/>' : '', '</div><div class=\'scb_s_western_blot_choose_samples_order\'>', (opt_data.western_blot.gel_type) ? '' : '<div class=\'order_overlay\'></div>', '<ol class=\'', (! opt_data.western_blot.wells_loaded) ? ' scb_s_western_blot_sortable_list  ' : ' scb_s_western_blot_static_list ', ' scb_s_western_blot_choose_samples_order_list\' >');
  var rList415 = opt_data.rows;
  var rListLen415 = rList415.length;
  for (var rIndex415 = 0; rIndex415 < rListLen415; rIndex415++) {
    var rData415 = rList415[rIndex415];
    output.append((rData415.kind == 'existing' && opt_data.western_blot.marker_loaded == true && rData415.lane.id == 'marker') ? '<li class="scb_s_western_blot_marker scb_s_western_blot_choose_samples_list_item scb_s_western_blot_sortable_item scb_s_movable_item" assignment_id=\'' + soy.$$escapeHtml(opt_data.assignment.id) + '\' experiment_id=\'' + soy.$$escapeHtml(opt_data.experiment.id) + '\' western_blot_id=\'' + soy.$$escapeHtml(opt_data.western_blot.id) + '\' id=\'' + soy.$$escapeHtml(rData415.lane.id) + '\'>Marker</li>' : '', (rData415.is_valid) ? '<li class="scb_s_western_blot_choose_samples_list_item scb_s_western_blot_sortable_item scb_s_movable_item" assignment_id=\'' + soy.$$escapeHtml(opt_data.assignment.id) + '\' experiment_id=\'' + soy.$$escapeHtml(opt_data.experiment.id) + '\' western_blot_id=\'' + soy.$$escapeHtml(opt_data.western_blot.id) + '\' id=\'' + soy.$$escapeHtml(rData415.lane.id) + '\' title=\'' + soy.$$escapeHtml(rData415.display_text) + ' - ' + soy.$$escapeHtml(rData415.lane.kinds[rData415.lane.kind].name) + '\'>' + soy.$$escapeHtml(rData415.display_text) + ' - ' + soy.$$escapeHtml(rData415.lane.kinds[rData415.lane.kind].name) + '</li>' : '');
  }
  output.append('</ol></div>', (opt_data.western_blot.marker_loaded == false && opt_data.western_blot.wells_loaded == false) ? '<div class=\'scb_s_western_blot_add_marker_wrapper\'><button class=\'scb_s_western_blot_load_marker\' western_blot_id=\'' + soy.$$escapeHtml(opt_data.western_blot.id) + '\' assignment_id=\'' + soy.$$escapeHtml(opt_data.assignment.id) + '\' experiment_id=\'' + soy.$$escapeHtml(opt_data.experiment.id) + '\'></button><div class=\'scb_s_western_blot_add_marker_text\'>ADD MARKER +</div></div>' : '', (opt_data.western_blot.wells_loaded == false) ? '<a class=\'scb_s_western_blot_load_all scb_s_navigation_button\' western_blot_id=\'' + soy.$$escapeHtml(opt_data.western_blot.id) + '\' assignment_id=\'' + soy.$$escapeHtml(opt_data.assignment.id) + '\' experiment_id=\'' + soy.$$escapeHtml(opt_data.experiment.id) + '\' href="#view=western_blot_gel&experiment_id=' + soy.$$escapeHtml(opt_data.experiment.id) + '&assignment_id=' + soy.$$escapeHtml(opt_data.assignment.id) + '&western_blot_id=' + soy.$$escapeHtml(opt_data.western_blot.id) + '">LOAD GEL</a>' : '', '</div><div class=\'scb_s_western_blot_samples_gel_area\'><div class=\'scb_s_western_blot_gel_tabs\'><div class=\'scb_s_western_blot_gel_tab scb_s_western_blot_gel_active\' contenteditable="true">GEL</div></div><div class=\'scb_s_western_blot_gel_content\'><canvas class=\'scb_s_western_blot_gel\' src=\'images/western_blot/SCB_WesternBlotting_GelNumbers.png\'/><div class=\'scb_s_western_blot_tools\'>', (opt_data.western_blot.wells_loaded == true && opt_data.western_blot.marker_loaded == true || opt_data.western_blot.wells_loaded == true) ? '<a class=\'scb_s_western_blot_run_gel_and_transfer scb_s_navigation_button\' western_blot_id=\'' + soy.$$escapeHtml(opt_data.western_blot.id) + '\' assignment_id=\'' + soy.$$escapeHtml(opt_data.assignment.id) + '\' experiment_id=\'' + soy.$$escapeHtml(opt_data.experiment.id) + '\' href="#view=western_blot_gel&experiment_id=' + soy.$$escapeHtml(opt_data.experiment.id) + '&assignment_id=' + soy.$$escapeHtml(opt_data.assignment.id) + '&western_blot_id=' + soy.$$escapeHtml(opt_data.western_blot.id) + '">RUN GEL & TRANSFER</a>' : '', '</div></div></div>');
  return opt_sb ? '' : output.toString();
};
...
scb_western_blot.display_lysate_types = function(opt_data, opt_sb) {
  ...
  if (soy.$$getMapKeys(opt_data.kinds).length < 1) {
    var kList494 = soy.$$getMapKeys(opt_data.kinds);
    var kListLen494 = kList494.length;
    for (var kIndex494 = 0; kIndex494 < kListLen494; kIndex494++) {
      var kData494 = kList494[kIndex494];
      output.append('<div class="scb_f_western_blot_select_lysate_type"  kind=\'', soy.$$escapeHtml(kData494), '\' cell_treatment_id=\'', soy.$$escapeHtml(opt_data.cell_treatment.id), '\' western_blot_id=\'', soy.$$escapeHtml(opt_data.western_blot.id), '\' assignment_id="', soy.$$escapeHtml(opt_data.assignment.id), '" experiment_id="', soy.$$escapeHtml(opt_data.experiment.id), '" lane_kind="', soy.$$escapeHtml(opt_data.lane.kind), '" lane_id="', (opt_data.lane.kind == 'existing') ? soy.$$escapeHtml(opt_data.lane.lane.id) : '', '">', soy.$$escapeHtml(opt_data.kinds[kData494].name), '</div>');
    }
  } else {
    if (soy.$$getMapKeys(opt_data.kinds).length == 1) {
      ...
      if (opt_data.lane.kind == 'existing') {
        ...
        for (var kIndex562 = 0; kIndex562 < kListLen562; kIndex562++) {
          ...
          output.append('<option value=\'', soy.$$escapeHtml(kData562), '\'', (opt_data.lane.lane.kind == kData562) ? 'selected="selected"' : '', '>', soy.$$escapeHtml(opt_data.kinds[kData562].name), '</option>');
        }
      } else {
        ...
        var kList577 = soy.$$getMapKeys(opt_data.kinds);
        var kListLen577 = kList577.length;
        for (var kIndex577 = 0; kIndex577 < kListLen577; kIndex577++) {
          var kData577 = kList577[kIndex577];
          output.append('<option value=\'', soy.$$escapeHtml(kData577), '\'>', soy.$$escapeHtml(opt_data.kinds[kData577].name), '</option>');
        }
      }
