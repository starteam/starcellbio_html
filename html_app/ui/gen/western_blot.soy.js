...
scb_western_blot.prepare_gel = function(opt_data, opt_sb) {
  ...
  for (var rIndex421 = 0; rIndex421 < rListLen421; rIndex421++) {
    ...
    output.append((rData421.kind == 'existing' && opt_data.western_blot.marker_loaded == true && rData421.lane.id == 'marker') ? '<li class="scb_s_western_blot_marker scb_s_western_blot_choose_samples_list_item scb_s_western_blot_sortable_item scb_s_movable_item" assignment_id=\'' + soy.$$escapeHtml(opt_data.assignment.id) + '\' experiment_id=\'' + soy.$$escapeHtml(opt_data.experiment.id) + '\' western_blot_id=\'' + soy.$$escapeHtml(opt_data.western_blot.id) + '\' id=\'' + soy.$$escapeHtml(rData421.lane.id) + '\'>Marker</li>' : '', (rData421.is_valid) ? '<li class="scb_s_western_blot_choose_samples_list_item scb_s_western_blot_sortable_item scb_s_movable_item" assignment_id=\'' + soy.$$escapeHtml(opt_data.assignment.id) + '\' experiment_id=\'' + soy.$$escapeHtml(opt_data.experiment.id) + '\' western_blot_id=\'' + soy.$$escapeHtml(opt_data.western_blot.id) + '\' id=\'' + soy.$$escapeHtml(rData421.lane.id) + '\' title=\'' + soy.$$escapeHtml(rData421.display_text) + ' - ' + soy.$$escapeHtml(rData421.lane.kinds[rData421.lane.kind].name) + '\'>' + soy.$$escapeHtml(rData421.display_text) + ' - ' + soy.$$escapeHtml(rData421.lane.kinds[rData421.lane.kind].name) + '</li>' : '');
  }
    ...
    if (soy.$$getMapKeys(opt_data.kinds).length == 1) {
      ...
      if (opt_data.lane.kind == 'existing') {
        ...
        for (var kIndex568 = 0; kIndex568 < kListLen568; kIndex568++) {
          ...
          output.append('<option value=\'', soy.$$escapeHtml(kData568), '\'', (opt_data.lane.lane.kind == kData568) ? 'selected="selected"' : '', '>', soy.$$escapeHtml(opt_data.kinds[kData568].name), '</option>');
        }
      } else {
        ...
        for (var kIndex583 = 0; kIndex583 < kListLen583; kIndex583++) {
          ...
          output.append('<option value=\'', soy.$$escapeHtml(kData583), '\'>', soy.$$escapeHtml(opt_data.kinds[kData583].name), '</option>');
        }
      }
