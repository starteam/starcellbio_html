...
scb_western_blot.display_tabs_selector = function(opt_data, opt_sb) {
  ...
  var wbList88 = opt_data.experiment.western_blot_list.list;
  var wbListLen88 = wbList88.length;
  for (var wbIndex88 = 0; wbIndex88 < wbListLen88; wbIndex88++) {
    var wbData88 = wbList88[wbIndex88];
    output.append((opt_data.western_blot.id == wbData88.id) ? '<span class=\'scb_s_western_blot_active\'><span class=\'scb_s_western_blot_selected\' western_blot_id=\'' + soy.$$escapeHtml(wbData88.id) + '\' assignment_id=\'' + soy.$$escapeHtml(opt_data.assignment.id) + '\' experiment_id=\'' + soy.$$escapeHtml(opt_data.experiment.id) + '\' contenteditable="true">' + soy.$$escapeHtml(wbData88.name) + '</span><button class=\'scb_s_western_blot_remove scb_f_western_blot_remove\' western_blot_id=\'' + soy.$$escapeHtml(wbData88.id) + '\' assignment_id=\'' + soy.$$escapeHtml(opt_data.assignment.id) + '\' experiment_id=\'' + soy.$$escapeHtml(opt_data.experiment.id) + '\'>| X<!--             <img src="images/setup/scb_remove.png"> --></button></span>' : '<a class=\'scb_f_open_western_blot scb_s_western_blot_open_western_blot\' href=\'#view=western_blot&experiment_id=' + soy.$$escapeHtml(opt_data.experiment.id) + '&assignment_id=' + soy.$$escapeHtml(opt_data.assignment.id) + '&western_blot_id=' + soy.$$escapeHtml(wbData88.id) + '\' western_blot_id=\'' + soy.$$escapeHtml(wbData88.id) + '\'>' + soy.$$escapeHtml(wbData88.name) + '</a>');
  }
  output.append('<span class=\'scb_s_western_blot_add_western_blot\'> <a class=\'scb_f_open_western_blot scb_s_western_blot_open_western_blot\' href=\'#view=western_blot&experiment_id=', soy.$$escapeHtml(opt_data.experiment.id), '&assignment_id=', soy.$$escapeHtml(opt_data.assignment.id), '\'>ADD<span class=\'scb_s_western_blot_add_cross_western_blot\'>| + </span></a></span></div>');
  return opt_sb ? '' : output.toString();
};
...
scb_western_blot.sample_prep = function(opt_data, opt_sb) {
  ...
  var rList128 = opt_data.rows;
  var rListLen128 = rList128.length;
  for (var rIndex128 = 0; rIndex128 < rListLen128; rIndex128++) {
    var rData128 = rList128[rIndex128];
    output.append('<tr class=\'scb_s_western_blot_samples_table_tr\'><td class=\'scb_s_western_blot_samples_table_td scb_s_experiment_setup_table_border\'>', (rData128.display_sample) ? '<input type="checkbox" class="scb_f_western_blot_sample_active" western_blot_id=\'' + soy.$$escapeHtml(opt_data.western_blot.id) + '\' assignment_id=\'' + soy.$$escapeHtml(opt_data.assignment.id) + '\' experiment_id=\'' + soy.$$escapeHtml(opt_data.experiment.id) + '\' cell_treatment_id=\'' + soy.$$escapeHtml(rData128.cell_treatment.id) + '\'' + ((rData128.is_sample_enabled) ? 'checked="checked"' : '') + '>' : '', '</td><td class=\'scb_s_western_blot_samples_table_td scb_s_experiment_setup_table_border\'>', (rData128.display_sample) ? soy.$$escapeHtml(rData128.display_text) : '', '</td><td class=\'scb_s_western_blot_samples_table_td scb_s_experiment_setup_table_border\'>');
    scb_western_blot.display_lysate_types({assignment: opt_data.assignment, experiment: opt_data.experiment, western_blot: opt_data.western_blot, cell_treatment: rData128.cell_treatment, kinds: opt_data.kinds, lane: rData128}, output);
    output.append('</td><td class=\'scb_s_western_blot_samples_table_td scb_s_experiment_setup_table_border scb_s_experiment_setup_table_border\'>', (rData128.kind == 'existing') ? '<button class="scb_f_western_blot_sample_remove" western_blot_id=\'' + soy.$$escapeHtml(opt_data.western_blot.id) + '\' assignment_id=\'' + soy.$$escapeHtml(opt_data.assignment.id) + '\' experiment_id=\'' + soy.$$escapeHtml(opt_data.experiment.id) + '\' lane_id=\'' + soy.$$escapeHtml(rData128.lane.id) + '\'' + ((rData128.is_sample_enabled) ? '' : 'disabled="disabled"') + '>X</button>' : '<button class="scb_f_western_blot_sample_remove" disabled="disabled">X</button>', '</td></tr>');
  }
...
scb_western_blot.prepare_gel = function(opt_data, opt_sb) {
  ...
  var rList229 = opt_data.rows;
  var rListLen229 = rList229.length;
  for (var rIndex229 = 0; rIndex229 < rListLen229; rIndex229++) {
    var rData229 = rList229[rIndex229];
    output.append((rData229.is_valid) ? '<li class="scb_s_western_blot_choose_samples_list_item" assignment_id=\'' + soy.$$escapeHtml(opt_data.assignment.id) + '\' experiment_id=\'' + soy.$$escapeHtml(opt_data.experiment.id) + '\' western_blot_id=\'' + soy.$$escapeHtml(opt_data.western_blot.id) + '\' id=\'' + soy.$$escapeHtml(rData229.lane.id) + '\'>' + soy.$$escapeHtml(rData229.display_text) + ' - ' + soy.$$escapeHtml(rData229.lane.kinds[rData229.lane.kind].name) + '</li>' : '');
  }
  output.append('</ol>');
  var start__soy247 = opt_data.rows.length + 1;
  output.append('<ol class=\'scb_s_western_blot_choose_samples_marker\' start=', soy.$$escapeHtml(start__soy247), '>', (opt_data.western_blot.marker_loaded == true) ? '<li class="scb_s_western_blot_marker">Marker</li>' : '', '</ol></div>', (opt_data.western_blot.marker_loaded == false) ? '<button class=\'scb_s_western_blot_load_marker scb_s_navigation_button\' western_blot_id=\'' + soy.$$escapeHtml(opt_data.western_blot.id) + '\' assignment_id=\'' + soy.$$escapeHtml(opt_data.assignment.id) + '\' experiment_id=\'' + soy.$$escapeHtml(opt_data.experiment.id) + '\'>LOAD MARKER</button>' : '', '</div><div class=\'scb_s_western_blot_samples_gel_area\'><div class=\'scb_s_western_blot_gel_tabs\'><div class=\'scb_s_western_blot_gel_tab scb_s_western_blot_gel_active\' contenteditable="true">GEL</div></div><div class=\'scb_s_western_blot_gel_content\'><!--');
...
scb_western_blot.display_lysate_types = function(opt_data, opt_sb) {
  ...
  if (soy.$$getMapKeys(opt_data.kinds).length > 1) {
    ...
    for (var kIndex284 = 0; kIndex284 < kListLen284; kIndex284++) {
      ...
      output.append('<div class="scb_f_western_blot_select_lysate_type"  kind=\'', soy.$$escapeHtml(kData284), '\' cell_treatment_id=\'', soy.$$escapeHtml(opt_data.cell_treatment.id), '\' western_blot_id=\'', soy.$$escapeHtml(opt_data.western_blot.id), '\' assignment_id="', soy.$$escapeHtml(opt_data.assignment.id), '" experiment_id="', soy.$$escapeHtml(opt_data.experiment.id), '" lane_kind="', soy.$$escapeHtml(opt_data.lane.kind), '" lane_id="', (opt_data.lane.kind == 'existing') ? soy.$$escapeHtml(opt_data.lane.lane.id) : '', '">', soy.$$escapeHtml(opt_data.kinds[kData284].name), '</div>');
    }
  } else {
    ...
    if (opt_data.lane.kind == 'existing') {
      var kList328 = soy.$$getMapKeys(opt_data.kinds);
      var kListLen328 = kList328.length;
      for (var kIndex328 = 0; kIndex328 < kListLen328; kIndex328++) {
        var kData328 = kList328[kIndex328];
        output.append('<option value=\'', soy.$$escapeHtml(kData328), '\'', (opt_data.lane.lane.kind == kData328) ? 'selected="selected"' : '', '>', soy.$$escapeHtml(opt_data.kinds[kData328].name), '</option>');
      }
    } else {
      ...
      var kList343 = soy.$$getMapKeys(opt_data.kinds);
      var kListLen343 = kList343.length;
      for (var kIndex343 = 0; kIndex343 < kListLen343; kIndex343++) {
        var kData343 = kList343[kIndex343];
        output.append('<option value=\'', soy.$$escapeHtml(kData343), '\'>', soy.$$escapeHtml(opt_data.kinds[kData343].name), '</option>');
      }
    }
