...
scb_western_blot.prepare_gel = function(opt_data, opt_sb) {
  ...
  output.append('<div class=\'scb_s_western_blot_samples_area\'><div class=\'scb_s_western_blot_choose_gel_type\'><!-- TODO: Gel Type stuff --><div class=\'scb_s_western_blot_choose_gel_type_title\'>Gel Type:</div>', (opt_data.western_blot.wells_loaded) ? ((opt_data.western_blot.gel_type == '.10') ? '&nbsp;&nbsp;&nbsp;10%' : '') + ((opt_data.western_blot.gel_type == '.12') ? '&nbsp;&nbsp;&nbsp;12%' : '') + ((opt_data.western_blot.gel_type == '.15') ? '&nbsp;&nbsp;&nbsp;15%' : '') : '<input class=\'scb_s_western_blot_choose_gel_type_input\' type="radio" name="gel_type" value=".10" western_blot_id=\'' + soy.$$escapeHtml(opt_data.western_blot.id) + '\' assignment_id=\'' + soy.$$escapeHtml(opt_data.assignment.id) + '\' experiment_id=\'' + soy.$$escapeHtml(opt_data.experiment.id) + '\' ' + ((opt_data.western_blot.gel_type == '.10') ? 'checked=\'checked\'' : '') + '/><span class="scb_s_western_blot_choose_gel_type_input_text">10%</span>&nbsp;&nbsp;<input class=\'scb_s_western_blot_choose_gel_type_input\' type="radio" name="gel_type" value=".12" western_blot_id=\'' + soy.$$escapeHtml(opt_data.western_blot.id) + '\' assignment_id=\'' + soy.$$escapeHtml(opt_data.assignment.id) + '\' experiment_id=\'' + soy.$$escapeHtml(opt_data.experiment.id) + '\' ' + ((opt_data.western_blot.gel_type == '.12') ? 'checked=\'checked\'' : '') + ' /><span class="scb_s_western_blot_choose_gel_type_input_text ">12%</span>&nbsp;<input class=\'scb_s_western_blot_choose_gel_type_input\' type="radio" name="gel_type" value=".15" western_blot_id=\'' + soy.$$escapeHtml(opt_data.western_blot.id) + '\' assignment_id=\'' + soy.$$escapeHtml(opt_data.assignment.id) + '\' experiment_id=\'' + soy.$$escapeHtml(opt_data.experiment.id) + '\' ' + ((opt_data.western_blot.gel_type == '.15') ? 'checked=\'checked\'' : '') + ' /><span class="scb_s_western_blot_choose_gel_type_input_text ">15%</span>', '</div><div class=\'scb_s_western_blot_samples_heading\'>Samples', (opt_data.western_blot.wells_loaded == false) ? '<span class=\'scb_s_wb_button_wrapper\'><button class=\'scb_f_wb_up_button\'>&#x25B2;</button>&nbsp;<button class=\'scb_f_wb_down_button\'>&#x25BC;</button></span><br/><br/>' : '', '</div><div class=\'scb_s_western_blot_choose_samples_order\'>', (opt_data.western_blot.gel_type) ? '' : '<div class=\'order_overlay\'></div>', '<ol class=\'scb_s_western_blot_choose_samples_order_list ', (! opt_data.western_blot.wells_loaded) ? ' scb_s_western_blot_sortable_list' : '', '\' >');
  var rList391 = opt_data.rows;
  var rListLen391 = rList391.length;
  for (var rIndex391 = 0; rIndex391 < rListLen391; rIndex391++) {
    var rData391 = rList391[rIndex391];
    output.append((opt_data.western_blot.marker_loaded == true && rData391.lane.id == 'marker') ? '<li class="scb_s_western_blot_marker scb_s_western_blot_choose_samples_list_item scb_s_western_blot_sortable_item scb_s_movable_item" assignment_id=\'' + soy.$$escapeHtml(opt_data.assignment.id) + '\' experiment_id=\'' + soy.$$escapeHtml(opt_data.experiment.id) + '\' western_blot_id=\'' + soy.$$escapeHtml(opt_data.western_blot.id) + '\' id=\'' + soy.$$escapeHtml(rData391.lane.id) + '\'>Marker</li>' : '', (rData391.is_valid) ? '<li class="scb_s_western_blot_choose_samples_list_item scb_s_western_blot_sortable_item scb_s_movable_item" assignment_id=\'' + soy.$$escapeHtml(opt_data.assignment.id) + '\' experiment_id=\'' + soy.$$escapeHtml(opt_data.experiment.id) + '\' western_blot_id=\'' + soy.$$escapeHtml(opt_data.western_blot.id) + '\' id=\'' + soy.$$escapeHtml(rData391.lane.id) + '\'>' + soy.$$escapeHtml(rData391.display_text) + ' - ' + soy.$$escapeHtml(rData391.lane.kinds[rData391.lane.kind].name) + '</li>' : '');
  }
...
scb_western_blot.display_lysate_types = function(opt_data, opt_sb) {
  ...
  if (soy.$$getMapKeys(opt_data.kinds).length < 1) {
    var kList466 = soy.$$getMapKeys(opt_data.kinds);
    var kListLen466 = kList466.length;
    for (var kIndex466 = 0; kIndex466 < kListLen466; kIndex466++) {
      var kData466 = kList466[kIndex466];
      output.append('<div class="scb_f_western_blot_select_lysate_type"  kind=\'', soy.$$escapeHtml(kData466), '\' cell_treatment_id=\'', soy.$$escapeHtml(opt_data.cell_treatment.id), '\' western_blot_id=\'', soy.$$escapeHtml(opt_data.western_blot.id), '\' assignment_id="', soy.$$escapeHtml(opt_data.assignment.id), '" experiment_id="', soy.$$escapeHtml(opt_data.experiment.id), '" lane_kind="', soy.$$escapeHtml(opt_data.lane.kind), '" lane_id="', (opt_data.lane.kind == 'existing') ? soy.$$escapeHtml(opt_data.lane.lane.id) : '', '">', soy.$$escapeHtml(opt_data.kinds[kData466].name), '</div>');
    }
  } else {
    if (soy.$$getMapKeys(opt_data.kinds).length == 1) {
      var kList490 = soy.$$getMapKeys(opt_data.kinds);
      var kListLen490 = kList490.length;
      for (var kIndex490 = 0; kIndex490 < kListLen490; kIndex490++) {
        var kData490 = kList490[kIndex490];
        output.append('<span class="scb_f_western_blot_select_lysate_type" cell_treatment_id=\'', soy.$$escapeHtml(opt_data.cell_treatment.id), '\' western_blot_id=\'', soy.$$escapeHtml(opt_data.western_blot.id), '\' assignment_id="', soy.$$escapeHtml(opt_data.assignment.id), '" experiment_id="', soy.$$escapeHtml(opt_data.experiment.id), '" lane_kind="', soy.$$escapeHtml(opt_data.lane.kind), '" lane_id="', (opt_data.lane.kind == 'existing') ? soy.$$escapeHtml(opt_data.lane.lane.id) : '', '" value=\'', soy.$$escapeHtml(kData490), '\'>', soy.$$escapeHtml(opt_data.kinds[kData490].name), '</span>');
      }
    } else {
      ...
      if (opt_data.lane.kind == 'existing') {
        var kList534 = soy.$$getMapKeys(opt_data.kinds);
        var kListLen534 = kList534.length;
        for (var kIndex534 = 0; kIndex534 < kListLen534; kIndex534++) {
          var kData534 = kList534[kIndex534];
          output.append('<option value=\'', soy.$$escapeHtml(kData534), '\'', (opt_data.lane.lane.kind == kData534) ? 'selected="selected"' : '', '>', soy.$$escapeHtml(opt_data.kinds[kData534].name), '</option>');
        }
      } else {
        ...
        var kList549 = soy.$$getMapKeys(opt_data.kinds);
        var kListLen549 = kList549.length;
        for (var kIndex549 = 0; kIndex549 < kListLen549; kIndex549++) {
          var kData549 = kList549[kIndex549];
          output.append('<option value=\'', soy.$$escapeHtml(kData549), '\'>', soy.$$escapeHtml(opt_data.kinds[kData549].name), '</option>');
        }
      }
