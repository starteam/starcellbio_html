...
scb_western_blot.sample_prep = function(opt_data, opt_sb) {
  ...
  output.append('<div class=\'scb_s_western_blot_samples_container\' ><div class=\'scb_s_western_blot_samples_table\'  ><table  role=\'grid\'><thead class=\'scb_s_western_blot_samples_table_head\'><td class=\'scb_s_western_blot_samples_table_heading sample_prep_select  scb_s_experiment_setup_table_border\' role=\'columnheader\'>Select</td><td class=\'scb_s_western_blot_samples_table_heading sample_prep_samples scb_s_experiment_setup_table_border\' role=\'columnheader\'>Samples</td><td class=\'scb_s_western_blot_samples_table_heading sample_prep_lysate  scb_s_experiment_setup_table_border\' role=\'columnheader\'>Lysate type</td><td class=\'scb_s_western_blot_samples_table_heading sample_prep_blank   scb_s_experiment_setup_table_border\' role=\'columnheader\'>&nbsp;</td></thead>');
  var rList247 = opt_data.rows;
  var rListLen247 = rList247.length;
  for (var rIndex247 = 0; rIndex247 < rListLen247; rIndex247++) {
    var rData247 = rList247[rIndex247];
    output.append('<tr  role=\'row\' class=\'scb_s_western_blot_samples_table_tr\'><td class=\'scb_s_western_blot_samples_table_td scb_s_experiment_setup_table_border\' style=\'width:96px;\'>', (rData247.display_sample) ? '<input type="checkbox" class="scb_f_western_blot_sample_active" western_blot_id=\'' + soy.$$escapeHtml(opt_data.western_blot.id) + '\' assignment_id=\'' + soy.$$escapeHtml(opt_data.assignment.id) + '\' experiment_id=\'' + soy.$$escapeHtml(opt_data.experiment.id) + '\' aria-checked=\'' + ((rData247.is_sample_enabled) ? 'true' : 'false') + '\' cell_treatment_id=\'' + soy.$$escapeHtml(rData247.cell_treatment.id) + '\' role=\'checkbox\'' + ((rData247.is_sample_enabled) ? 'checked="checked"' : '') + '>' : '', '</td><td class=\'scb_s_western_blot_samples_table_td scb_s_experiment_setup_table_border\'  style=\'width:491px;\'>', (rData247.display_sample) ? soy.$$escapeHtml(rData247.display_text) : '', '</td><td class=\'scb_s_western_blot_samples_table_td scb_s_experiment_setup_table_border\'>');
    scb_western_blot.display_lysate_types({assignment: opt_data.assignment, experiment: opt_data.experiment, western_blot: opt_data.western_blot, cell_treatment: rData247.cell_treatment, kinds: opt_data.kinds, lane: rData247}, output);
    output.append('</td><td class=\'scb_s_western_blot_samples_table_td scb_s_experiment_setup_table_border scb_s_experiment_setup_table_border\'>', (rData247.kind == 'existing') ? '<button class="scb_f_western_blot_sample_remove" western_blot_id=\'' + soy.$$escapeHtml(opt_data.western_blot.id) + '\' assignment_id=\'' + soy.$$escapeHtml(opt_data.assignment.id) + '\' experiment_id=\'' + soy.$$escapeHtml(opt_data.experiment.id) + '\' lane_id=\'' + soy.$$escapeHtml(rData247.lane.id) + '\' role=\'button\' aria-label=\'Close Tab\'' + ((rData247.is_sample_enabled) ? '' : 'disabled="disabled"') + ' >&#215;</button>' : '<button  role=\'button\' class="scb_f_western_blot_sample_remove" disabled="disabled"  aria-label=\'Close Tab\'>&#215;</button>', '</td></tr>');
  }
...
scb_western_blot.display_lysate_types = function(opt_data, opt_sb) {
  ...
  if (soy.$$getMapKeys(opt_data.kinds).length < 1) {
    var kList488 = soy.$$getMapKeys(opt_data.kinds);
    var kListLen488 = kList488.length;
    for (var kIndex488 = 0; kIndex488 < kListLen488; kIndex488++) {
      var kData488 = kList488[kIndex488];
      output.append('<div class="scb_f_western_blot_select_lysate_type"  kind=\'', soy.$$escapeHtml(kData488), '\' cell_treatment_id=\'', soy.$$escapeHtml(opt_data.cell_treatment.id), '\' western_blot_id=\'', soy.$$escapeHtml(opt_data.western_blot.id), '\' assignment_id="', soy.$$escapeHtml(opt_data.assignment.id), '" experiment_id="', soy.$$escapeHtml(opt_data.experiment.id), '" lane_kind="', soy.$$escapeHtml(opt_data.lane.kind), '" lane_id="', (opt_data.lane.kind == 'existing') ? soy.$$escapeHtml(opt_data.lane.lane.id) : '', '">', soy.$$escapeHtml(opt_data.kinds[kData488].name), '</div>');
    }
  } else {
    if (soy.$$getMapKeys(opt_data.kinds).length == 1) {
      var kList512 = soy.$$getMapKeys(opt_data.kinds);
      var kListLen512 = kList512.length;
      for (var kIndex512 = 0; kIndex512 < kListLen512; kIndex512++) {
        var kData512 = kList512[kIndex512];
        output.append('<span class="scb_f_western_blot_select_lysate_type" cell_treatment_id=\'', soy.$$escapeHtml(opt_data.cell_treatment.id), '\' western_blot_id=\'', soy.$$escapeHtml(opt_data.western_blot.id), '\' assignment_id="', soy.$$escapeHtml(opt_data.assignment.id), '" experiment_id="', soy.$$escapeHtml(opt_data.experiment.id), '" lane_kind="', soy.$$escapeHtml(opt_data.lane.kind), '" lane_id="', (opt_data.lane.kind == 'existing') ? soy.$$escapeHtml(opt_data.lane.lane.id) : '', '" value=\'', soy.$$escapeHtml(kData512), '\'>', soy.$$escapeHtml(opt_data.kinds[kData512].name), '</span>');
      }
    } else {
      ...
      if (opt_data.lane.kind == 'existing') {
        var kList556 = soy.$$getMapKeys(opt_data.kinds);
        var kListLen556 = kList556.length;
        for (var kIndex556 = 0; kIndex556 < kListLen556; kIndex556++) {
          var kData556 = kList556[kIndex556];
          output.append('<option role=\'option\' value=\'', soy.$$escapeHtml(kData556), '\'', (opt_data.lane.lane.kind == kData556) ? 'selected="selected"' : '', '>', soy.$$escapeHtml(opt_data.kinds[kData556].name), '</option>');
        }
      } else {
        ...
        var kList571 = soy.$$getMapKeys(opt_data.kinds);
        var kListLen571 = kList571.length;
        for (var kIndex571 = 0; kIndex571 < kListLen571; kIndex571++) {
          var kData571 = kList571[kIndex571];
          output.append('<option role=\'option\' value=\'', soy.$$escapeHtml(kData571), '\'>', soy.$$escapeHtml(opt_data.kinds[kData571].name), '</option>');
        }
      }
