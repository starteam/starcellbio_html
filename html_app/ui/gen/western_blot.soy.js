...
scb_western_blot.display_tabs_selector = function(opt_data, opt_sb) {
  ...
  if (opt_data.experiment.western_blot_list.list.length < 5) {
    output.append('<button class=\'scb_s_western_blot_left_western_blot_left_small\' disabled=\'disabled\' western_blot_id=\'', soy.$$escapeHtml(opt_data.western_blot.id), '\' assignment_id=\'', soy.$$escapeHtml(opt_data.assignment.id), '\' experiment_id=\'', soy.$$escapeHtml(opt_data.experiment.id), '\'></button>');
    var wbList112 = opt_data.experiment.western_blot_list.list;
    var wbListLen112 = wbList112.length;
    for (var wbIndex112 = 0; wbIndex112 < wbListLen112; wbIndex112++) {
      var wbData112 = wbList112[wbIndex112];
      output.append((opt_data.western_blot.id == wbData112.id) ? '<span class=\'scb_s_western_blot_active\'><input class=\'scb_s_western_blot_selected\' western_blot_id=\'' + soy.$$escapeHtml(wbData112.id) + '\' assignment_id=\'' + soy.$$escapeHtml(opt_data.assignment.id) + '\' experiment_id=\'' + soy.$$escapeHtml(opt_data.experiment.id) + '\' value =\'' + soy.$$escapeHtml(wbData112.name) + '\' type=\'text\' maxlength=10 ></input><button class=\'scb_s_western_blot_remove scb_f_western_blot_remove\' western_blot_id=\'' + soy.$$escapeHtml(wbData112.id) + '\' assignment_id=\'' + soy.$$escapeHtml(opt_data.assignment.id) + '\' experiment_id=\'' + soy.$$escapeHtml(opt_data.experiment.id) + '\' >| &#215;</button></span>' : '<a class=\'scb_f_open_western_blot scb_s_western_blot_open_western_blot\' href=\'#view=western_blot&experiment_id=' + soy.$$escapeHtml(opt_data.experiment.id) + '&assignment_id=' + soy.$$escapeHtml(opt_data.assignment.id) + '&western_blot_id=' + soy.$$escapeHtml(wbData112.id) + '\' western_blot_id=\'' + soy.$$escapeHtml(wbData112.id) + '\'>' + soy.$$escapeHtml(wbData112.name) + '</a>');
    }
    output.append('<span class=\'scb_s_western_blot_add_western_blot\' assignment_id=\'', soy.$$escapeHtml(opt_data.assignment.id), '\' experiment_id=\'', soy.$$escapeHtml(opt_data.experiment.id), '\' western_blot_id=\'', soy.$$escapeHtml(opt_data.experiment.western_blot_list.list[opt_data.experiment.western_blot_list.list.length - 1].id), '\'><a class=\'scb_f_open_western_blot scb_s_western_blot_open_western_blot\' href=\'#view=western_blot&experiment_id=', soy.$$escapeHtml(opt_data.experiment.id), '&assignment_id=', soy.$$escapeHtml(opt_data.assignment.id), '\'><span class=\'scb_s_add_tab\'>ADD </span><span class=\'scb_s_western_blot_add_cross_western_blot\'>| + </span></a></span><button class=\'scb_s_western_blot_right_western_blot_right_small\' disabled=\'disabled\' western_blot_id=\'', soy.$$escapeHtml(opt_data.western_blot.id), '\' assignment_id=\'', soy.$$escapeHtml(opt_data.assignment.id), '\' experiment_id=\'', soy.$$escapeHtml(opt_data.experiment.id), '\' ></button>');
  } else {
    ...
    if (opt_data.experiment.western_blot_list.list.length - 1 == opt_data.experiment.western_blot_list.start_tabs_index + 3) {
      var wbList170 = opt_data.experiment.western_blot_list.list;
      var wbListLen170 = wbList170.length;
      for (var wbIndex170 = 0; wbIndex170 < wbListLen170; wbIndex170++) {
        var wbData170 = wbList170[wbIndex170];
        output.append((wbIndex170 >= opt_data.experiment.western_blot_list.start_tabs_index && wbIndex170 < opt_data.experiment.western_blot_list.start_tabs_index + 4) ? (opt_data.western_blot.id == wbData170.id) ? '<span class=\'scb_s_western_blot_active scb_s_western_blot_more_open_western_blot\'><input class=\'scb_s_western_blot_selected\' western_blot_id=\'' + soy.$$escapeHtml(wbData170.id) + '\' assignment_id=\'' + soy.$$escapeHtml(opt_data.assignment.id) + '\' experiment_id=\'' + soy.$$escapeHtml(opt_data.experiment.id) + '\' value =\'' + soy.$$escapeHtml(wbData170.name) + '\' type=\'text\' maxlength=10 ></input><button class=\'scb_s_western_blot_remove scb_f_western_blot_remove\' western_blot_id=\'' + soy.$$escapeHtml(wbData170.id) + '\' assignment_id=\'' + soy.$$escapeHtml(opt_data.assignment.id) + '\' experiment_id=\'' + soy.$$escapeHtml(opt_data.experiment.id) + '\'>| &#215;</button></span>' : '<a class=\'scb_f_open_western_blot scb_s_western_blot_open_western_blot scb_s_western_blot_more_open_western_blot\' href=\'#view=western_blot&experiment_id=' + soy.$$escapeHtml(opt_data.experiment.id) + '&assignment_id=' + soy.$$escapeHtml(opt_data.assignment.id) + '&western_blot_id=' + soy.$$escapeHtml(wbData170.id) + '\' western_blot_id=\'' + soy.$$escapeHtml(wbData170.id) + '\'>' + soy.$$escapeHtml(wbData170.name) + '</a>' : '');
      }
      ...
      var wbList215 = opt_data.experiment.western_blot_list.list;
      var wbListLen215 = wbList215.length;
      for (var wbIndex215 = 0; wbIndex215 < wbListLen215; wbIndex215++) {
        var wbData215 = wbList215[wbIndex215];
        output.append((wbIndex215 >= opt_data.experiment.western_blot_list.start_tabs_index && wbIndex215 < opt_data.experiment.western_blot_list.start_tabs_index + 5) ? (opt_data.western_blot.id == wbData215.id) ? '<span class=\'scb_s_western_blot_active scb_s_western_blot_more_open_western_blot\'><input class=\'scb_s_western_blot_selected\' western_blot_id=\'' + soy.$$escapeHtml(wbData215.id) + '\' assignment_id=\'' + soy.$$escapeHtml(opt_data.assignment.id) + '\' experiment_id=\'' + soy.$$escapeHtml(opt_data.experiment.id) + '\' value =\'' + soy.$$escapeHtml(wbData215.name) + '\' type=\'text\' maxlength=10 ></input><button class=\'scb_s_western_blot_remove scb_f_western_blot_remove\' western_blot_id=\'' + soy.$$escapeHtml(wbData215.id) + '\' assignment_id=\'' + soy.$$escapeHtml(opt_data.assignment.id) + '\' experiment_id=\'' + soy.$$escapeHtml(opt_data.experiment.id) + '\'>| &#215;</button></span>' : '<a class=\'scb_f_open_western_blot scb_s_western_blot_open_western_blot scb_s_western_blot_more_open_western_blot\' href=\'#view=western_blot&experiment_id=' + soy.$$escapeHtml(opt_data.experiment.id) + '&assignment_id=' + soy.$$escapeHtml(opt_data.assignment.id) + '&western_blot_id=' + soy.$$escapeHtml(wbData215.id) + '\' western_blot_id=\'' + soy.$$escapeHtml(wbData215.id) + '\'>' + soy.$$escapeHtml(wbData215.name) + '</a>' : '');
      }
    }
...
scb_western_blot.sample_prep = function(opt_data, opt_sb) {
  ...
  var rList272 = opt_data.rows;
  var rListLen272 = rList272.length;
  for (var rIndex272 = 0; rIndex272 < rListLen272; rIndex272++) {
    var rData272 = rList272[rIndex272];
    output.append('<tr class=\'scb_s_western_blot_samples_table_tr\'><td class=\'scb_s_western_blot_samples_table_td scb_s_experiment_setup_table_border\' style=\'width:96px;\'>', (rData272.display_sample) ? '<input type="checkbox" class="scb_f_western_blot_sample_active" western_blot_id=\'' + soy.$$escapeHtml(opt_data.western_blot.id) + '\' assignment_id=\'' + soy.$$escapeHtml(opt_data.assignment.id) + '\' experiment_id=\'' + soy.$$escapeHtml(opt_data.experiment.id) + '\' cell_treatment_id=\'' + soy.$$escapeHtml(rData272.cell_treatment.id) + '\'' + ((rData272.is_sample_enabled) ? 'checked="checked"' : '') + '>' : '', '</td><td class=\'scb_s_western_blot_samples_table_td scb_s_experiment_setup_table_border\'  style=\'width:491px;\'>', (rData272.display_sample) ? soy.$$escapeHtml(rData272.display_text) : '', '</td><td class=\'scb_s_western_blot_samples_table_td scb_s_experiment_setup_table_border\'>');
    scb_western_blot.display_lysate_types({assignment: opt_data.assignment, experiment: opt_data.experiment, western_blot: opt_data.western_blot, cell_treatment: rData272.cell_treatment, kinds: opt_data.kinds, lane: rData272}, output);
    output.append('</td><td class=\'scb_s_western_blot_samples_table_td scb_s_experiment_setup_table_border scb_s_experiment_setup_table_border\'>', (rData272.kind == 'existing') ? '<button class="scb_f_western_blot_sample_remove" western_blot_id=\'' + soy.$$escapeHtml(opt_data.western_blot.id) + '\' assignment_id=\'' + soy.$$escapeHtml(opt_data.assignment.id) + '\' experiment_id=\'' + soy.$$escapeHtml(opt_data.experiment.id) + '\' lane_id=\'' + soy.$$escapeHtml(rData272.lane.id) + '\'' + ((rData272.is_sample_enabled) ? '' : 'disabled="disabled"') + '>&#215;</button>' : '<button class="scb_f_western_blot_sample_remove" disabled="disabled">&#215;</button>', '</td></tr>');
  }
...
scb_western_blot.prepare_gel = function(opt_data, opt_sb) {
  ...
  var rList377 = opt_data.rows;
  var rListLen377 = rList377.length;
  for (var rIndex377 = 0; rIndex377 < rListLen377; rIndex377++) {
    var rData377 = rList377[rIndex377];
    output.append((rData377.is_valid) ? '<li class="scb_s_western_blot_choose_samples_list_item" assignment_id=\'' + soy.$$escapeHtml(opt_data.assignment.id) + '\' experiment_id=\'' + soy.$$escapeHtml(opt_data.experiment.id) + '\' western_blot_id=\'' + soy.$$escapeHtml(opt_data.western_blot.id) + '\' id=\'' + soy.$$escapeHtml(rData377.lane.id) + '\'>' + soy.$$escapeHtml(rData377.display_text) + ' - ' + soy.$$escapeHtml(rData377.lane.kinds[rData377.lane.kind].name) + '</li>' : '');
  }
  output.append('</ol>');
  var start__soy395 = opt_data.rows_valid + 1;
  output.append('<ol class=\'scb_s_western_blot_choose_samples_marker\' start=', soy.$$escapeHtml(start__soy395), '>', (opt_data.western_blot.marker_loaded == true) ? '<li class="scb_s_western_blot_marker">Marker</li>' : '', '</ol></div>', (opt_data.western_blot.marker_loaded == false) ? '<button class=\'scb_s_western_blot_load_marker scb_s_navigation_button\' western_blot_id=\'' + soy.$$escapeHtml(opt_data.western_blot.id) + '\' assignment_id=\'' + soy.$$escapeHtml(opt_data.assignment.id) + '\' experiment_id=\'' + soy.$$escapeHtml(opt_data.experiment.id) + '\'>LOAD MARKER</button>' : '', '</div><div class=\'scb_s_western_blot_samples_gel_area\'><div class=\'scb_s_western_blot_gel_tabs\'><div class=\'scb_s_western_blot_gel_tab scb_s_western_blot_gel_active\' contenteditable="true">GEL</div></div><div class=\'scb_s_western_blot_gel_content\'><!--');
