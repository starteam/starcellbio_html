			...
			template : {
				...
				experiment_templates : {
					...
					'treatment_protocol_template':{
						'P1':{
							...
							treatment_list: {list:[{schedule_value:0, schedule:'immediately', duration_value:3600 * 24 * 3, duration: '3 d', drug_list:{list:[
				...
				primary_anti_body : {
					1 : {
						...
						secondary : [1],
						marks: [{weight:24,intensity:.11},{weight:36,intensity:.4},{weight:48,intensity:.04}]
					},
					2 : {
						name : 'mouse anti-let-60',
						secondary : [3],
						marks: [{weight:48,intensity:.04}]
					},
					3 : {
						name : 'goat anti-lin15A',
						secondary : [2],
						marks: [{weight:12,intensity:.02}]
					},
					9 : {
						name : 'goat anti-lin15B',
						secondary : [2],
						marks: [{weight:100,intensity:.01},{weight:129,intensity:.11}]
					},
					4 : {
			...
			template : {
				...
				experiment_templates: {
					...
					'treatment_protocol_template':{
						'P1':{
							...
							treatment_list: {list:[{schedule_value:0, schedule:'0 min', duration_value:3600*18, duration: '18h', drug_list:{list:[
								{drug_id:1, concentration_id:0}
							]}}							
							]},
							collection_schedule_list: {list:[{schedule:"18h",schedule_value:3600*18,id:'3'},],},
						...
						'P2':{
							...
							collection_schedule_list: {list:[{schedule:"3h 10 min",schedule_value:3600*18+600,id:'31'},],},
						...
						'P3':{
							...
							collection_schedule_list: {list:[{schedule:"18h 25 min",schedule_value:3600*18+25*60,id:'325'},],},							
                            stimulation_time: '10 minutes',
						},
						'P4':{
				...
				primary_anti_body : {
					1 : {
						...
						secondary:[1],
						marks: [{weight:44,intensity:0},{weight:42,intensity:0}]
					},
					2 : {
						name : 'rabbit anti ERK1/2',
						secondary:[1],
						marks: [{weight:44,intensity:1},{weight:42,intensity:1}]
					},
					3 : {
						name : 'rabbit P-EGFR',
						secondary:[1],
						marks: [{weight:175,intensity:0}]
					},
					4 : {
						name : 'rabbit EGFR',
						secondary:[1],
						marks: [{weight:134,intensity:1}]
					},
					5 : {
						name : 'rabbit anti tubulin',
						secondary:[1],
						marks: [{weight:50,intensity:1}]
					},
				},
				secondary_anti_body : {
					1 : {
...
var __assigment_facs = {
			...
			template : {
				...
				experiment_templates: {
					'default':{
						collection_schedule_list: {list:[{schedule:"10 min",schedule_value:600,id:'10'},{schedule:"30 min",schedule_value:1800,id:'30'},{schedule:"60 min",schedule_value:3600,id:'60'},],},
					},
					treatment_protocol_template:{
						'default':{
						collection_schedule_list: {list:[{schedule:"10 min",schedule_value:600,id:'10'},{schedule:"30 min",schedule_value:1800,id:'30'},{schedule:"60 min",schedule_value:3600,id:'60'},],},
				...
				primary_anti_body : {
					...
					2 : {
						...
						secondary:[3],
						marks: [{weight:120,intensity:.01},{weight:129,intensity:.11}]
					},
					3 : {
						name : 'mouse anti-mouse cdk2',
						secondary:[3],
						marks: [{weight:140,intensity:.01},{weight:129,intensity:.11}]
					},
				},
				secondary_anti_body : {
					1 : {
